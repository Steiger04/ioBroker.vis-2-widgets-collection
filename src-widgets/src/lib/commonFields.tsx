...
export interface CommonFieldsRxData {
    ...
    [key: `iconSmall${string}`]: string | undefined;
    [key: `icon${string}`]: string | number | undefined;
    [key: `iconSize${string}`]: number | string | undefined;
    [key: `iconColor${string}`]: string | undefined;
    [key: `iconHover${string}`]: number | undefined;
    [key: `iconXOffset${string}`]: string | undefined;
    [key: `iconYOffset${string}`]: string | undefined;
    [key: `noHeader${string}`]: boolean | undefined;
    [key: `noHeaderIcon${string}`]: boolean | undefined;
    [key: `header${string}`]: string | number | undefined;
    [key: `headerSize${string}`]: number | string | undefined;
    [key: `valueSize${string}`]: number | string | undefined;
    [key: `noFooter${string}`]: boolean | undefined;
    [key: `footer${string}`]: number | string | undefined;
    [key: `footerSize${string}`]: number | string | undefined;
    [key: `noCard${string}`]: boolean | undefined;
    [key: `squaredCorner${string}`]: boolean | undefined;
    [key: `textColor${string}`]: string | undefined;
    [key: `outlined${string}`]: boolean | undefined;
    [key: `outlinedFrame${string}`]: boolean | undefined;
    [key: `basePadding${string}`]: number | undefined;
    [key: `baseElevation${string}`]: number | undefined;
    [key: `square${string}`]: boolean | undefined;
    [key: `ellipse${string}`]: boolean | undefined;
    [key: `circle${string}`]: boolean | undefined;
    [key: `background${string}`]: string | undefined;
    [key: `backgroundColor${string}`]: string | undefined;
    [key: `frameBackground${string}`]: string | undefined;
    [key: `frameBackgroundColor${string}`]: string | undefined;
    // für states-Objekte
    [key: `label${string}`]: string | undefined;
    [key: `fontSize${string}`]: string | number | undefined;
    [key: `value${string}`]: ioBroker.StateValue | string | number | undefined;
    'signals-count': number | undefined;
    [key: `signals-color-${number}`]: string | undefined;

    // Active-State Overrides (visAttrs "group_active")
