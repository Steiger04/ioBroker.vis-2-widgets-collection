...
export interface LightFieldsRxData {
...
interface ExtendedWidgetData extends WidgetData, LightFieldsRxData {
    values_count?: number;
    value1?: boolean;
    alias1?: string;
    value2?: boolean;
...
const RGB_ROLES: Record<string, keyof LightFieldsRxData> = {
...
const lightFields = (): RxWidgetInfoAttributesField[] => [
    {
        type: 'custom',
    ...
    },
    {
        ...
        hidden: (data: WidgetData) =>
            (data as Partial<LightFieldsRxData>).colorLightType === 'cct' ||
            (data as Partial<LightFieldsRxData>).colorLightType === 'none',
    },
    {
        ...
        hidden: (data: WidgetData) =>
            (data as Partial<LightFieldsRxData>).colorLightType === 'none' ||
            (data as Partial<LightFieldsRxData>).colorLightType === 'cct' ||
            (data as Partial<LightFieldsRxData>).colorLightUIComponent !== 'wheel',
    },
    {
        type: 'custom',
        component: () => <CollectionDivider />,
    ...
    },
    {
        type: 'custom',
        component: () => <CollectionDivider />,
        hidden: (data: WidgetData) => (data as Partial<LightFieldsRxData>).colorLightType === 'none',
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['cct', 'rgbcct', 'r/g/b/cct', 'h/s/v/cct'].includes(
                (data as Partial<LightFieldsRxData>).colorLightType || '',
            ),
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['cct', 'rgbcct', 'r/g/b/cct', 'h/s/v/cct'].includes(
                (data as Partial<LightFieldsRxData>).colorLightType || '',
            ) || !(data as Partial<LightFieldsRxData>).colorLightTemperatureOid,
    },
    {
    ...
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['rgb', 'rgbcct'].includes((data as Partial<LightFieldsRxData>).colorLightType || ''),
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['r/g/b', 'r/g/b/cct'].includes((data as Partial<LightFieldsRxData>).colorLightType || ''),
    },
    {
    ...
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['h/s/v', 'h/s/v/cct'].includes((data as Partial<LightFieldsRxData>).colorLightType || ''),
    },
    {
    ...
    },
    {
        ...
        hidden: (data: WidgetData) =>
            !['cct', 'h/s/v', 'h/s/v/cct'].includes((data as Partial<LightFieldsRxData>).colorLightType || ''),
    },
];

export default lightFields;
