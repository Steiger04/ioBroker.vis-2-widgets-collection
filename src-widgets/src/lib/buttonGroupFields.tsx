...
const buttonGroupFields = (): (RxWidgetInfoAttributesField | ExtendedField)[] => [
    {
        type: 'custom',
    ...
    // Button group color with fallback to textColor
    createColorField({ name: 'buttonGroupColor', label: 'button_group_color', fallbackFields: ['textColor'] }),
];
