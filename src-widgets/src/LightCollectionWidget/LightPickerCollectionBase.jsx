...
const ColorWheelIcon = (props) => (
	<SvgIcon component={ColorWheelSvg} viewBox="0 0 128 128" {...props} />
);
...
const CctWhiteIcon = (props) => (
	<SvgIcon viewBox="0 0 512 512" {...props}>
		<defs>
			...
			<filter id="insetShadow" x="-50%" y="-50%" width="200%" height="200%">
				...
				<feComposite
					...
					result="inverse"
				/>
				<feFlood floodColor="#FFF176" floodOpacity="0.4" />
		...
		<circle cx="256" cy="256" r="252" fill="#FFF176" />
...
function LightPickerCollectionBase() {
	...
	useEffect(() => {
		...
		const setSaturation = () =>
			saturationChanged && (color.saturation = roundedSaturation);
