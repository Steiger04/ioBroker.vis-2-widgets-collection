...
const findSegment = (highlights, value, maxValue) => {
    const segment = highlights.find(highlight => {
        ...
        return (
			...
			highlight.icon */
            value >= highlight.from && (value < highlight.to || (value === highlight.to && value === maxValue))
        );
    });
    return segment || null;
};
        ...
        if (paper0 && paper1) {
            if (segment) {
                ...
                paper1.style.borderColor =
                    !wrappedContent && (segment?.state.backgroundColorActive || segment?.state.backgroundColor || null);
                ...
                paper0.style.borderColor =
                    !wrappedContent &&
                    ((segment?.state.frameBackgroundColor && `${segment?.state.frameBackgroundColor}!important`) ||
                        null);
                ...
                paper1.style.borderColor =
                    !wrappedContent &&
                    ((segment?.state.backgroundColor && `${segment?.state.backgroundColor}!important`) || null);
        ...
        >
            ...
            >
                <Gauge
                    ...
                    // Basic Options
                    width={gaugeRef.current?.clientWidth - Number(widget.data.gaugePadding)}
                    height={gaugeRef.current?.clientHeight - Number(widget.data.gaugePadding)}
