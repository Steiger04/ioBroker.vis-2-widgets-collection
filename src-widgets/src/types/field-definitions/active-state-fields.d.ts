 ...
 *
 * @remarks
 * Diese Interface definiert alle Active-State Override-Properties, die verwendet werden,
 * wenn ein Widget-Element im aktiven Zustand ist (z.B. ausgewählter Slider-Wert,
 * aktiver Button in ButtonGroup).
 *
 * Generiert durch commonFields({ groupName: 'Active', allFields: false }) in Runtime.
 *
 * Used by:
