...
let __tla = Promise.all([
    ...
    let te, se, ae;
    te = t => {
        const { classes: s, checked: l, disabled: d, edge: n } = t,
            c = {
                root: ['root', l && 'checked', d && 'disabled', n && `edge${X(n)}`],
                input: ['input'],
            };
        return Y(c, oe, s);
    };
