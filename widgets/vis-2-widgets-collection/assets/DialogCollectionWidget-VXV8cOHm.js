...
import { C as G, __tla as __tla_2 } from './Close-CQt1dGJP.js';
...
let __tla = Promise.all([
    ...
    function Y({ open: r, handleClose: l, widget: e, data: a, getWidgetView: i }) {
        ...
        const p = n.useRef(null),
            [u, d] = n.useState(null),
            o = (_a = p.current) == null ? void 0 : _a.header;
        n.useEffect(() => {
            e.data.dialogHeaderAsTitle &&
                o &&
                u &&
                (e.data.dialogHeaderAsTitle && ((o.style.width = '0px'), (o.style.height = '0px')),
                (u.innerHTML = a.header),
                (u.style.height = 'auto'),
                (u.style.width = 'auto'));
        }, [o, u, a.header, e.data.dialogHeaderAsTitle]);
        const g = t.jsx(A, {
            sx: {
                alignSelf: 'flex-end',
            ...
            children: t.jsx(x, {
                ...
                children: t.jsxs(k, {
                    ...
                    children: [
                        ...
                        t.jsxs(t.Fragment, {
                            children: [
                                e.data.dialogCloseButtonBottom &&
                                    t.jsx(y, {
                                        sx: {
                                            width: '100%',
                                            opacity: '0.5',
    ...
    function oe() {
        ...
        const [r, l] = n.useState(false),
            ...
            { data: o, oidValue: g } = V('dialogId'),
            s = (_a = i.data.dialogIdObject) == null ? void 0 : _a._id,
            T =
                ((_b = i.data.dialogIdObject) == null ? void 0 : _b.type) === 'boolean' ||
                !i.data.oid ||
                i.data.oid === 'nothing_selected';
        n.useEffect(
            () => () => {
        ...
        const S = n.useCallback(() => {
            ...
            v = n.useMemo(
                () => i.data.onlyIcon || (!i.data.onlyText && !i.data.onlyIcon),
                [i.data.onlyIcon, i.data.onlyText],
            ),
            B = n.useMemo(
                () => i.data.onlyText || (!i.data.onlyText && !i.data.onlyIcon),
                [i.data.onlyText, i.data.onlyIcon],
            ),
            I = n.useMemo(
                () => ({
            ...
            w = n.useMemo(
                ...
                [o.iconYOffset, o.iconXOffset, o.iconSizeOnly, o.icon, o.iconColor, o.forceColorMask],
            ),
            D = n.useMemo(
                () => ({
                    overflow: 'hidden',
                ...
                [o.valueSize, o.textColorActive, o.textColor],
            );
    ...
    j = class extends L {
        ...
        renderWidgetBody(l) {
            ...
            return (
                l.widget.data.noCard || l.widget.usedInWidget
                    ? (this.wrappedCollectionContent = false)
                    : (this.wrappedCollectionContent = true),
                N(this.wrapContent(t.jsx(le, {})), e)
            );
        }
    };
});
export { __tla, j as default };
