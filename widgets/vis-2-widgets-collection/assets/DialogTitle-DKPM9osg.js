...
import { a as k, g as P, u as w, $ as go, P as N, ar as j, ae as mo, b, d as h, s as g, j as n, W as u, e as W, O as xo, as as bo, m as U, T as ho, __tla as __tla_1 } from "./useData-B9ZrPGFV.js";
let Fo, No, jo;
let __tla = Promise.all([
  ...
  Fo = p.forwardRef(function(o, t) {
    const r = w({
    ...
    }, { "aria-describedby": i, "aria-labelledby": l, "aria-modal": m = true, BackdropComponent: f, BackdropProps: A, children: I, className: Y, disableEscapeKeyDown: T = false, fullScreen: L = false, fullWidth: O = false, maxWidth: X = "sm", onBackdropClick: M, onClick: $, onClose: v, open: R, PaperComponent: z = N, PaperProps: B = {}, scroll: E = "paper", slots: H = {}, slotProps: K = {}, TransitionComponent: V = j, transitionDuration: F = s, TransitionProps: q, ...G } = r, c = {
      ...r,
      ...
      $ && $(d), y.current && (y.current = null, M && M(d), v && v(d, "backdropClick"));
    }, S = mo(l), Z = p.useMemo(() => ({
      titleId: S
    }), [
      S
