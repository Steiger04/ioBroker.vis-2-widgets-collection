...
let __tla = Promise.all([
    ...
    Co = e => {
        const { classes: o, scroll: t, maxWidth: r, fullWidth: a, fullScreen: s } = e,
            i = {
                root: ['root'],
    ...
    So = g('div', {
        ...
        overridesResolver: (e, o) => {
            ...
            return [o.container, o[`scroll${u(t.scroll)}`]];
        },
    })({
        height: '100%',
        '@media print': {
    ...
    To = g('div', {
        ...
        overridesResolver: (e, o) => {
            const { ownerState: t } = e;
            return [o.root, t.dividers && o.dividers];
        },
    })(
        U(({ theme: e }) => ({
            flex: '1 1 auto',
    ...
    jo = p.forwardRef(function (o, t) {
        const r = w({
            ...
            { className: a, dividers: s = false, ...i } = r,
            l = {
                ...r,
                dividers: s,
            },
    ...
    No = p.forwardRef(function (o, t) {
        const r = w({
            ...
            { className: a, id: s, ...i } = r,
            l = r,
            m = Mo(l),
            { titleId: f = s } = p.useContext(_);
        return n.jsx($o, {
            component: 'h2',
            className: h(m.root, a),
            ownerState: l,
...
export { Fo as D, __tla, No as a, jo as b };
