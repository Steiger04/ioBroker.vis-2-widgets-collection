...
let __tla = Promise.all([
    ...
    const $ = () => [
        ...
        },
        {
            ...
            type: 'id',
            label: 'cid',
            onChange: M(['boolean', 'number', 'string', 'mixed'], 'cid'),
        },
        {
            type: 'custom',
            component: () =>
    ...
    function K() {
        const i = d.useRef(null),
            { width: e = 300 } = T(i == null ? void 0 : i.current),
            a = d.useContext(B),
            { widget: o } = a,
            p = o.data.cidObject,
            j = o.data.oidObject,
            { data: r, states: s } = F('oid'),
            { value: c, updateValue: g } = y('oid'),
            { updateValue: m } = y('cid'),
            _ = j == null ? void 0 : j.type,
            I = ['boolean', 'number', 'string', 'mixed'].includes(_ || ''),
            x = d.useMemo(() => {
                if (c == null) return -1;
                const t = String(c);
    ...
    k = class extends z {
            ...
            return {
                ...
                visAttrs: [
                    ...
                    },
                    {
                        ...
                        fields: [...A(['boolean', 'number', 'string', 'mixed']), ...L(), ...$()],
                    },
                    {
                        name: 'values',
                        label: 'values',
        ...
        renderWidgetBody(e) {
            ...
            return (
                ...
                E(this.wrapContent(n.jsx(K, {})), a)
            );
        }
    };
});
export { __tla, k as default };
