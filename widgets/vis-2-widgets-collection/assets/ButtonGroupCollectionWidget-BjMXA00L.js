...
let __tla = Promise.all([
    ...
    function Q() {
        const n = w.useContext(M),
            { widget: t, theme: i } = n,
            u = t.data.oidObject,
            { data: g, states: h, activeIndex: G } = D('oid'),
            { value: x, updateValue: b } = U('oid'),
            k = t.data.buttonGroupVariant,
            m = t.data.buttonGroupOrientation,
            d = u == null ? void 0 : u.type,
            v = d === 'boolean' || d === 'number' || d === 'string' || d === 'mixed',
            a = m === 'vertical',
            r = k === 'outlined',
            l = t.data.buttonGroupColor ? S(t.data.buttonGroupColor, 0.6) : S(i.palette.text.primary, 0.6),
            T = w.useCallback(
                s => {
                    b(s);
                },
                ...
                o.jsx(c, {
                    ...
                    children: o.jsx(K, {
                        ...
                        children: h.map(({ value: s, ...e }, f) => {
                            const I = G === f + 1,
                                { hasGradient: y, hoverBackground: V, selectedBackground: O } = J(e.background),
                                C = B(e.textColor);
                            return o.jsx(
                                X,
                                {
            ...
            return {
                ...
                visAttrs: [
                    ...
                    },
                    {
                        name: 'buttonGroup',
                        label: 'button_group',
                        fields: [...E(['string', 'number', 'boolean', 'mixed']), ...q(), ...Y()],
                    },
                    {
                        name: 'active',
                        label: 'group_active',
