...
let __tla = Promise.all([
    ...
    no = o => {
        const {
            ...
            S = {
                ...
                startIcon: ['icon', 'startIcon', `iconSize${i(p)}`],
                endIcon: ['icon', 'endIcon', `iconSize${i(p)}`],
    ...
    io = y(q, {
        ...
        Q(({ theme: o }) => {
            const a = o.palette.mode === 'light' ? o.palette.grey[300] : o.palette.grey[800],
                t = o.palette.mode === 'light' ? o.palette.grey.A100 : o.palette.grey[700];
            return {
                ...o.typography.button,
                minWidth: 64,
                padding: '6px 16px',
                    ...
                    ...Object.entries(o.palette)
                        ...
                        .map(([n]) => ({
                            ...
                            style: {
                                ...
                                '--variant-outlinedBorder': o.vars
                                    ? `rgba(${o.vars.palette[n].mainChannel} / 0.5)`
                                    : v(o.palette[n].main, 0.5),
                                ...
                                '@media (hover: hover)': {
                                    '&:hover': {
                                        ...
                                        '--variant-textBg': o.vars
                                            ? `rgba(${o.vars.palette[n].mainChannel} / ${o.vars.palette.action.hoverOpacity})`
                                            : v(o.palette[n].main, o.palette.action.hoverOpacity),
                                        '--variant-outlinedBorder': (o.vars || o).palette[n].main,
                                        '--variant-outlinedBg': o.vars
                                            ? `rgba(${o.vars.palette[n].mainChannel} / ${o.vars.palette.action.hoverOpacity})`
                                            : v(o.palette[n].main, o.palette.action.hoverOpacity),
                                    },
                                },
                            ...
                            '@media (hover: hover)': {
                                '&:hover': {
                                    ...
                                    '--variant-textBg': o.vars
                                        ...
                                        : v(o.palette.text.primary, o.palette.action.hoverOpacity),
                                    '--variant-outlinedBg': o.vars
                                        ? `rgba(${o.vars.palette.text.primaryChannel} / ${o.vars.palette.action.hoverOpacity})`
                                        : v(o.palette.text.primary, o.palette.action.hoverOpacity),
                                },
    ...
    ro = y('span', {
        ...
        overridesResolver: (o, a) => {
            const { ownerState: t } = o;
            return [a.startIcon, t.loading && a.startIconLoadingStart, a[`iconSize${i(t.size)}`]];
        },
    })(({ theme: o }) => ({
        display: 'inherit',
        marginRight: 8,
    ...
    eo = y('span', {
        ...
        overridesResolver: (o, a) => {
            const { ownerState: t } = o;
            return [a.endIcon, t.loading && a.endIconLoadingEnd, a[`iconSize${i(t.size)}`]];
        },
    })(({ theme: o }) => ({
        display: 'inherit',
        marginRight: -4,
    ...
    co = x.forwardRef(function (a, t) {
        ...
        return e.jsxs(io, {
            ...
            ..._,
            classes: r,
            children: [V, g !== 'end' && W, f, g === 'end' && W, F],
        });
    });
});
export { co as B, __tla };
