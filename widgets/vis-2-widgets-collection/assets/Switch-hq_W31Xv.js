...
import { S as U, __tla as __tla_2 } from './SwitchBase-Dz75iFvF.js';
let H;
let __tla = Promise.all([
    ...
    A = t => {
        const { classes: a, edge: s, size: l, color: h, checked: w, disabled: g } = t,
            v = {
                root: ['root', s && `edge${i(s)}`, `size${i(l)}`],
                switchBase: ['switchBase', `color${i(h)}`, w && 'checked', g && 'disabled'],
                thumb: ['thumb'],
                track: ['track'],
                input: ['input'],
            },
    ...
    E = u('span', {
        ...
        overridesResolver: (t, a) => {
            ...
            return [a.root, s.edge && a[`edge${i(s.edge)}`], a[`size${i(s.size)}`]];
        },
    })({
        display: 'inline-flex',
        width: 58,
        ...
        d(({ theme: t }) => ({
            '&:hover': {
                backgroundColor: t.vars
                    ...
                    : m(t.palette.action.active, t.palette.action.hoverOpacity),
                '@media (hover: none)': {
                            ...
                            [`&.${o.checked}`]: {
                                ...
                                '&:hover': {
                                    backgroundColor: t.vars
                                        ...
                                        : m(t.palette[a].main, t.palette.action.hoverOpacity),
                                    '@media (hover: none)': {
                                        backgroundColor: 'transparent',
                                    },
                                },
                                [`&.${o.disabled}`]: {
                                    color: t.vars
                                        ? t.vars.palette.Switch[`${a}DisabledColor`]
                                        : `${t.palette.mode === 'light' ? I(t.palette[a].main, 0.62) : N(t.palette[a].main, 0.55)}`,
                                },
                            },
                            [`&.${o.checked} + .${o.track}`]: {
