...
import { a as D, g as U, u as A, v as E, aH as H, k as W, T as P, j as c, d as v, s as x, x as F, e as z, m as L, __tla as __tla_1 } from "./usePopoverPositioning-CABAc1cn.js";
let Z;
let __tla = Promise.all([
  ...
  Z = y.forwardRef(function(o, s) {
    const r = A({
      props: o,
      name: "MuiFormControlLabel"
    }), { checked: p, className: d, componentsProps: m = {}, control: a, disabled: R, disableTypography: S, inputRef: K, label: k, labelPlacement: T = "end", name: O, onChange: Q, required: _, slots: q = {}, slotProps: $ = {}, value: V, ...j } = r, f = E(), C = R ?? a.props.disabled ?? (f == null ? void 0 : f.disabled), b = _ ?? a.props.required, g = {
      disabled: C,
      required: b
    };
    [
