...
import { u as P, d as Xt, __tla as __tla_1 } from './useValueState-CqWHZ0NH.js';
import { v as d, __tla as __tla_2 } from './vis2CollectionWidget__loadShare__react__loadShare__-Cz8-6BjL.js';
import { B as Kt, __tla as __tla_3 } from './Button-BOWf2z70.js';
...
let __tla = Promise.all([
    ...
    const Je =
            ...
            if (n && r[n]) {
                ...
                if (o && o.common) {
                    ...
                    if (c) {
                        const s = r;
                        (await Promise.all(
                            Object.values(c).map(async u => {
                                const h = u.common.role;
                                if (h && et[h] && (!r[h] || r[h] === 'nothing_selected') && n !== h) {
                                    const a = et[h];
                                    ((s[a] = u._id),
                                        await zt(['boolean', 'number', 'string', 'mixed'], a)(e, r, i, t),
                                        a === 'colorLightTemperatureOid' &&
                                            (!s.colorLightCtMin && u.common.min && (s.colorLightCtMin = u.common.min),
                                            !s.colorLightCtMax && u.common.max && (s.colorLightCtMax = u.common.max)),
                                        a === 'colorLightSwitchOid' &&
                                            ((s.values_count = 2),
                                            (s.value1 = true),
                                            (s.alias1 = 'TRUE'),
                                            (s.value2 = false),
        ...
        Qt = () => [
            ...
            },
            {
                ...
                default: false,
                hidden: e =>
                    e.colorLightType === 'none' || e.colorLightType === 'cct' || e.colorLightUIComponent !== 'wheel',
            },
            {
                type: 'custom',
                component: () => v.jsx(z, {}),
            ...
            },
            {
                ...
                hidden: e => !['cct', 'rgbcct', 'r/g/b/cct', 'h/s/v/cct'].includes(e.colorLightType || ''),
            },
            {
                ...
                hidden: e =>
                    !['cct', 'rgbcct', 'r/g/b/cct', 'h/s/v/cct'].includes(e.colorLightType || '') ||
                    !e.colorLightTemperatureOid,
            },
            {
            ...
            },
            {
                ...
                hidden: e =>
                    !['cct', 'rgbcct', 'r/g/b/cct', 'h/s/v/cct'].includes(e.colorLightType || '') ||
                    e.colorLightType === 'none',
            },
            {
                name: 'colorLightRgbHexOid',
                type: 'id',
                label: 'color_light_rgb_hex_oid',
                hidden: e => !['rgb', 'rgbcct'].includes(e.colorLightType || ''),
            },
            {
                name: 'colorLightRedOid',
                type: 'id',
                label: 'color_light_red_oid',
                hidden: e => !['r/g/b', 'r/g/b/cct'].includes(e.colorLightType || ''),
            },
            {
            ...
            },
            {
                ...
                hidden: e => !['h/s/v', 'h/s/v/cct'].includes(e.colorLightType || ''),
            },
            {
            ...
            },
            {
                ...
                hidden: e => !['cct', 'h/s/v', 'h/s/v/cct'].includes(e.colorLightType || ''),
            },
        ];
    function qt({ onClick: e = () => {}, onLongPress: r = () => {}, ms: i = 300 } = {}) {
        const t = d.useRef(null),
            ...
            s = d.useCallback(
                h => {
                    l.current === null &&
                        ((l.current = h.pointerId),
                        (n.current = h),
                        (o.current = false),
                        (t.current = setTimeout(c, i)));
                },
                [c, i],
            ),
            u = d.useCallback(
                h => {
                    if (h.pointerId !== l.current) return;
                    const a = n.current,
                        f = o.current;
    ...
    function Jt(e) {
        const r = t => {
                ...
                const { widget: o } = n,
                    [l, c] = d.useState(false),
                    s = o.data,
                    { value: u, updateValue: h } = P('colorLightSwitchOid'),
                    { data: a } = at('colorLightSwitchOid'),
                    f = Zt(s) && s.colorLightButton,
                    b = ((_a = f ? s.colorLightSwitchOidObject : void 0) == null ? void 0 : _a.type) === 'boolean',
                    x = qt({
                        onClick: () => h(!u),
                        onLongPress: () => c(true),
                        ms: f ? (s.colorLightDelayLongPress ?? 500) : 500,
                    }),
                    m = f ? (s.colorLightSliderWidth || 1) * 28 : 28,
                    w =
                        f && typeof s.colorLightModalWidth == 'number' && s.colorLightModalWidth > 0
                            ? s.colorLightModalWidth
                            : ((f && s.colorLightModalHeight) || 300) + 40 + 12 + m;
                return f
                    ? v.jsxs(v.Fragment, {
                          children: [
                              v.jsxs(st, {
                                  ...
                                  children: [
                                      ...
                                      v.jsx(Kt, {
                                          ...
                                          children: v.jsx(Nt, {
                                              ...
                                              style: {
                                                  width:
                                                      (typeof a.iconSizeOnly == 'number' &&
                                                          `calc(100% * ${a.iconSizeOnly} / 100)`) ||
                                                      '100%',
                                                  height:
                                                      (typeof a.iconSizeOnly == 'number' &&
                                                          `calc(100% * ${a.iconSizeOnly} / 100)`) ||
    ...
    var S,
        ...
        H = {},
        Me = [],
        er = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;
    function B(e, r) {
    ...
    function L(e, r, i) {
        var t,
            ...
            l,
            c = arguments;
        if (((r = B({}, r)), arguments.length > 3)) for (i = [i], t = 3; t < arguments.length; t++) i.push(c[t]);
        if ((i != null && (r.children = i), e != null && e.defaultProps != null))
            for (n in e.defaultProps) r[n] === void 0 && (r[n] = e.defaultProps[n]);
    ...
    function xe(e) {
        ((!e.__d && (e.__d = true) && ne.push(e) === 1) || Se !== S.debounceRendering) &&
            ((Se = S.debounceRendering), (S.debounceRendering || dt)(rr));
    }
    function rr() {
        var e, r, i, t, n, o, l, c;
        for (
            ne.sort(function (s, u) {
            ...
            e.__d &&
                ...
                l &&
                    ((i = []),
                    (t = Re(l, n, B({}, n), r.__n, l.ownerSVGElement !== void 0, null, i, c, o ?? oe(n))),
                    pt(i, n),
                    t != o && vt(n)));
    }
    function mt(e, r, i, t, n, o, l, c, s) {
        var u,
            ...
            m = x.length;
        if (
            (c == H && (c = o != null ? o[0] : m ? oe(i, 0) : null),
            (u = 0),
            (r.__k = Ie(r.__k, function (_) {
                if (_ != null) {
                    if (
                        ((_.__p = r),
                        (_.__b = r.__b + 1),
                        (a = x[u]) === null || (a && _.key == a.key && _.type === a.type))
                    )
                        x[u] = void 0;
                    else
                        for (h = 0; h < m; h++) {
                            if ((a = x[h]) && _.key == a.key && _.type === a.type) {
                                x[h] = void 0;
                                break;
                            }
                            a = null;
                    ...
                    if (
                        ((f = Re(e, _, (a = a || H), t, n, o, l, null, c, s)),
                        (h = _.ref) && a.ref != h && (b || (b = [])).push(h, _.__c || f, _),
                        f != null)
                    ) {
            ...
            (r.__e = y),
            o != null && typeof r.type != 'function')
        )
            for (u = o.length; u--; ) o[u] != null && gt(o[u]);
        for (u = m; u--; ) x[u] != null && _t(x[u], x[u]);
        if (b) for (u = 0; u < b.length; u++) bt(b[u], b[++u], b[++u]);
    }
    function Ie(e, r, i) {
    ...
    function tt(e, r, i) {
        r[0] === '-'
            ? e.setProperty(r, i)
            : (e[r] = typeof i == 'number' && er.test(r) === false ? i + 'px' : (i ?? ''));
    }
    function rt(e, r, i, t, n) {
        var o, l, c, s, u;
        if (
            !(
                (r = n ? (r === 'className' ? 'class' : r) : r === 'class' ? 'className' : r) === 'key' ||
                r === 'children'
            )
        )
            if (r === 'style')
                if (((o = e.style), typeof i == 'string')) o.cssText = i;
                else {
                    if ((typeof t == 'string' && ((o.cssText = ''), (t = null)), t))
                        for (l in t) (i && l in i) || tt(o, l, '');
                    if (i) for (c in i) (t && i[c] === t[c]) || tt(o, c, i[c]);
                }
            else
                r[0] === 'o' && r[1] === 'n'
                    ? ((s = r !== (r = r.replace(/Capture$/, ''))),
                      (u = r.toLowerCase()),
                      (r = (u in e ? u : r).slice(2)),
                      i
                          ? (t || e.addEventListener(r, it, s), ((e.t || (e.t = {}))[r] = i))
                          : e.removeEventListener(r, it, s))
                    : r !== 'list' && r !== 'tagName' && r !== 'form' && !n && r in e
                      ? (e[r] = i ?? '')
                      : typeof i != 'function' &&
                        r !== 'dangerouslySetInnerHTML' &&
                        (r !== (r = r.replace(/^xlink:?/, ''))
                            ? i == null || i === false
                                ? e.removeAttributeNS('http://www.w3.org/1999/xlink', r.toLowerCase())
                                : e.setAttributeNS('http://www.w3.org/1999/xlink', r.toLowerCase(), i)
                            : i == null || i === false
                              ? e.removeAttribute(r)
                              : e.setAttribute(r, i));
    }
    ...
    function Re(e, r, i, t, n, o, l, c, s, u) {
        ...
        try {
            e: if (typeof p == 'function') {
                if (
                    ((m = r.props),
                    (_ = (h = p.contextType) && t[h.__c]),
                    (w = h ? (_ ? _.props.value : h.__p) : t),
                    i.__c
                        ? (x = (a = r.__c = i.__c).__p = a.__E)
                        : ('prototype' in p && p.prototype.render
                              ? (r.__c = a = new p(m, w))
                              : ((r.__c = a = new Q(m, w)), (a.constructor = p), (a.render = or)),
                          _ && _.sub(a),
                          (a.props = m),
                          a.state || (a.state = {}),
                          (a.context = w),
                    ...
                    p.getDerivedStateFromProps != null &&
                        B(a.__s == a.state ? (a.__s = B({}, a.__s)) : a.__s, p.getDerivedStateFromProps(m, a.__s)),
                    f)
                )
                    (p.getDerivedStateFromProps == null && a.componentWillMount != null && a.componentWillMount(),
                        a.componentDidMount != null && l.push(a));
                else {
                    if (
                        (p.getDerivedStateFromProps == null &&
                            c == null &&
                            a.componentWillReceiveProps != null &&
                            a.componentWillReceiveProps(m, w),
                        !c && a.shouldComponentUpdate != null && a.shouldComponentUpdate(m, a.__s, w) === false)
                    ) {
                        for (
                            a.props = m,
                                a.state = a.__s,
                                a.__d = false,
                                a.__v = r,
                                r.__e = s != null ? (s !== i.__e ? s : i.__e) : null,
                                r.__k = i.__k,
                                h = 0;
                            h < r.__k.length;
                            h++
                ...
                for (
                    g = a.props,
                        ...
                        r.__k = Ie(h != null && h.type == ce && h.key == null ? h.props.children : h),
                        a.getChildContext != null && (t = B(B({}, t), a.getChildContext())),
                        f || a.getSnapshotBeforeUpdate == null || (b = a.getSnapshotBeforeUpdate(g, y)),
                        mt(e, r, i, t, n, o, l, s, u),
                        a.base = r.__e;
                    (h = a.__h.pop());
                )
                    (a.__s && (a.state = a.__s), h.call(a));
                (f || g == null || a.componentDidUpdate == null || a.componentDidUpdate(g, y, b),
                    x && (a.__E = a.__p = null));
    ...
    function nr(e, r, i, t, n, o, l, c) {
        ...
        if (((n = r.type === 'svg' || n), e == null && o != null)) {
            for (s = 0; s < o.length; s++)
                if ((u = o[s]) != null && (r.type === null ? u.nodeType === 3 : u.localName === r.type)) {
                    ((e = u), (o[s] = null));
                    break;
                }
        }
        if (e == null) {
            ...
            ((e = n ? document.createElementNS('http://www.w3.org/2000/svg', r.type) : document.createElement(r.type)),
                (o = null));
        }
        return (
            r.type === null
                ? f !== g && (o != null && (o[o.indexOf(e)] = null), (e.data = g))
                : r !== i &&
                  (o != null && (o = Me.slice.call(e.childNodes)),
                  (h = (f = i.props || H).dangerouslySetInnerHTML),
                  (a = g.dangerouslySetInnerHTML),
                  c || ((a || h) && ((a && h && a.__html == h.__html) || (e.innerHTML = (a && a.__html) || ''))),
                  ir(e, g, f, n, c),
                  (r.__k = r.props.children),
                  a || mt(e, r, i, t, r.type !== 'foreignObject' && n, o, l, H, c),
                  c ||
                      ('value' in g &&
                          g.value !== void 0 &&
                          g.value !== e.value &&
                          (e.value = g.value == null ? '' : g.value),
                      'checked' in g && g.checked !== void 0 && g.checked !== e.checked && (e.checked = g.checked))),
            e
        );
    }
    function bt(e, r, i) {
    ...
    function lr(e, r, i) {
        ...
        (S.__p && S.__p(e, r),
            ...
            Re(
                ...
                n ? null : Me.slice.call(r.childNodes),
                o,
                false,
                H,
                t,
    ...
    ((S = {}),
        (Q.prototype.setState = function (e, r) {
            var i = (this.__s !== this.state && this.__s) || (this.__s = B({}, this.state));
            ((typeof e != 'function' || (e = e(i, this.props))) && B(i, e),
                e != null && this.__v && ((this.u = false), r && this.__h.push(r), xe(this)));
        }),
        (Q.prototype.forceUpdate = function (e) {
            this.__v && (e && this.__h.push(e), (this.u = true), xe(this));
        }),
        (Q.prototype.render = ce),
        (ne = []),
        (dt = typeof Promise == 'function' ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
        (Se = S.debounceRendering),
        (S.__e = function (e, r, i) {
            for (var t; (r = r.__p); )
                if ((t = r.__c) && !t.__p)
                    try {
    ...
    var sr = '[-\\+]?\\d+%?',
        ...
        F = '(?:' + hr + ')|(?:' + sr + ')',
        yt = '[\\s|\\(]+(' + F + ')[,|\\s]+(' + F + ')[,|\\s]+(' + F + ')\\s*\\)?',
        xt = '[\\s|\\(]+(' + F + ')[,|\\s]+(' + F + ')[,|\\s]+(' + F + ')[,|\\s]+(' + F + ')\\s*\\)?',
        ur = new RegExp('rgb' + yt),
        dr = new RegExp('rgba' + xt),
        fr = new RegExp('hsl' + yt),
        gr = new RegExp('hsla' + xt),
        ae = '^(?:#?|0x?)',
        V = '([0-9a-fA-F]{1})',
        G = '([0-9a-fA-F]{2})',
        vr = new RegExp(ae + V + V + V + '$'),
        mr = new RegExp(ae + V + V + V + V + '$'),
        pr = new RegExp(ae + G + G + G + '$'),
        br = new RegExp(ae + G + G + G + G + '$'),
        _r = 2e3,
        yr = 4e4,
        re = Math.log,
        X = Math.round,
    ...
    var K = (function () {
            ...
            return (
                ...
                (e.hslToHsv = function (t) {
                    var n = t.l * 2,
                        o = (t.s * (n <= 100 ? n : 200 - n)) / 100,
                        l = n + o < 1e-9 ? 0 : (2 * o) / (n + o);
                    return {
                        h: t.h,
                        s: I(l * 100, 0, 100),
                        v: I((n + o) / 2, 0, 100),
                ...
                (e.kelvinToRgb = function (t) {
                    ...
                    return (
                        n < 66
                            ? ((o = 255),
                              (l =
                                  -155.25485562709179 - 0.44596950469579133 * (l = n - 2) + 104.49216199393888 * re(l)),
                              (c =
                                  n < 20
                                      ? 0
                                      : -254.76935184120902 +
                                        0.8274096064007395 * (c = n - 10) +
                                        115.67994401066147 * re(c)))
                            : ((o = 351.97690566805693 + 0.114206453784165 * (o = n - 55) - 40.25366309332127 * re(o)),
                              (l = 325.4494125711974 + 0.07943456536662342 * (l = n - 50) - 28.0852963507957 * re(l)),
                              (c = 255)),
                        {
                            r: I(q(o), 0, 255),
                            g: I(q(l), 0, 255),
                ...
                ar(e, [
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            ...
                            if (
                                ((n = ur.exec(t))
                                    ? ((o = E(n[1], 255)), (l = E(n[2], 255)), (c = E(n[3], 255)))
                                    : (n = dr.exec(t)) &&
                                      ((o = E(n[1], 255)), (l = E(n[2], 255)), (c = E(n[3], 255)), (s = E(n[4], 1))),
                                n)
                            )
                                this.rgb = {
                                    r: o,
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            ...
                            if (
                                ((n = vr.exec(t))
                                    ? ((o = A(n[1]) * 17), (l = A(n[2]) * 17), (c = A(n[3]) * 17))
                                    : (n = mr.exec(t))
                                      ? ((o = A(n[1]) * 17), (l = A(n[2]) * 17), (c = A(n[3]) * 17), (s = A(n[4]) * 17))
                                      : (n = pr.exec(t))
                                        ? ((o = A(n[1])), (l = A(n[2])), (c = A(n[3])))
                                        : (n = br.exec(t)) &&
                                          ((o = A(n[1])), (l = A(n[2])), (c = A(n[3])), (s = A(n[4]))),
                                n)
                            )
                                this.rgb = {
                                    r: o,
                    ...
                    },
                    {
                        ...
                        set: function (t) {
                            ...
                            if (
                                ((n = fr.exec(t))
                                    ? ((o = E(n[1], 360)), (l = E(n[2], 100)), (c = E(n[3], 100)))
                                    : (n = gr.exec(t)) &&
                                      ((o = E(n[1], 360)), (l = E(n[2], 100)), (c = E(n[3], 100)), (s = E(n[4], 1))),
                                n)
                            )
                                this.hsl = {
                                    h: o,
    ...
    function Pe(e) {
        var r,
            ...
            l = e.padding,
            c = e.sliderShape,
            s = e.layoutDirection === 'horizontal';
        return (
            (t = (r = t) != null ? r : l * 2 + o * 2),
            c === 'circle'
                ? {
    ...
    function Sr(e, r) {
        var i = Pe(e),
            ...
            o = i.handleRange,
            l = i.handleStart,
            c = e.layoutDirection === 'horizontal',
            s = Lr(e, r),
            u = c ? t / 2 : n / 2,
            h = l + (s / 100) * o;
        return (
    ...
    function Cr(e, r) {
        ...
        switch (e.sliderType) {
            ...
            case 'alpha':
                return [
                    [0, 'rgba(' + t.r + ',' + t.g + ',' + t.b + ',0)'],
                    [100, 'rgb(' + t.r + ',' + t.g + ',' + t.b + ')'],
                ];
            case 'kelvin':
                for (
                    var n = [], o = e.minTemperature, l = e.maxTemperature, c = 8, s = l - o, u = o, h = 0;
                    u < l;
                    u += s / c, h += 1
                ) {
                    var a = K.kelvinToRgb(u),
                        f = a.r,
                        g = a.g,
                        y = a.b;
                    n.push([(100 / c) * h, 'rgb(' + f + ',' + g + ',' + y + ')']);
                }
                return n;
            case 'hue':
                return [
    ...
    function Er(e, r) {
        var i = r.hsv,
            ...
            o = t.cy,
            l = St(e),
            c = (180 + Ct(e, i.h, true)) * (Lt / 360),
            s = (i.s / 100) * l,
            u = e.wheelDirection === 'clockwise' ? -1 : 1;
        return {
            x: n + s * Math.cos(c) * u,
            y: o + s * Math.sin(c) * u,
        };
    ...
    function nt(e, r, i) {
        var t = se(e),
            ...
            l = St(e);
        ((r = n - r), (i = o - i));
        var c = Ct(e, Math.atan2(-i, -r) * (360 / Lt)),
            s = Math.min(wt(r, i), l);
        return {
            h: Math.round(c),
    ...
    function Ir(e) {
        ...
        var r = window.navigator.userAgent,
            i = /^((?!chrome|android).)*safari/i.test(r),
            t = /iPhone|iPod|iPad/i.test(r),
            n = window.location;
    ...
    var Rr = {
        ...
        lt = ['mousemove', 'touchmove', 'mouseup', 'touchend'],
        he = (function (e) {
            function r(i) {
            ...
            return (
                ...
                (r.prototype.render = function (t) {
                    var n = this.handleEvent.bind(this),
                        ...
                        c = t.margin === null ? t.sliderMargin : t.margin,
                        s = {
                            overflow: 'visible',
                            display: l ? 'inline-block' : 'block',
                        };
                    return (
                        t.index > 0 && (s[l ? 'marginLeft' : 'marginTop'] = c),
                        L(ce, null, t.children(this.uid, o, s))
                    );
                }),
                (r.prototype.handleEvent = function (t) {
                    var n = this,
                        o = this.props.onInput,
                        l = this.base.getBoundingClientRect();
                    t.preventDefault();
                    var c = t.touches ? t.changedTouches[0] : t,
                        s = c.clientX - l.left,
                        u = c.clientY - l.top;
                    switch (t.type) {
                        case 'mousedown':
    ...
    function le(e) {
        var r = e.activeIndex,
            i = r !== void 0 && r < e.colors.length ? e.colors[r] : e.color,
            t = Pe(e),
            n = t.width,
            o = t.height,
            l = t.radius,
    ...
    function Pr(e) {
        var r = je(e),
            ...
            l = e.parent,
            c = e.activeIndex,
            s = c !== void 0 && c < e.colors.length ? e.colors[c] : e.color,
            u = Mr(e, s),
            h = o.map(function (f) {
                return Ar(e, f);
            });
        function a(f, g, y) {
            if (y === 0) {
                var b = kt(e, f, g, h);
                b !== null ? l.setActiveColor(b) : ((l.inputActive = true), (s.hsv = ot(e, f, g)), e.onInput(y, e.id));
    ...
    var jr = 'conic-gradient(red, yellow, lime, aqua, blue, magenta, red)',
        Tr = 'conic-gradient(red, magenta, blue, aqua, lime, yellow, red)';
    function Ot(e) {
        var r = se(e),
            i = r.width,
            t = e.colors;
    ...
    var Et = (function (e) {
        ...
        return (
            ...
            (r.prototype = Object.create(e && e.prototype)),
            (r.prototype.constructor = r),
            (r.prototype.addColor = function (t, n) {
                n === void 0 && (n = this.colors.length);
                var o = new K(t, this.onColorChange.bind(this));
                (this.colors.splice(n, 0, o),
                    this.colors.forEach(function (l, c) {
                        return (l.index = c);
                    }),
                    this.state &&
                        this.setState({
            ...
            (r.prototype.removeColor = function (t) {
                ...
                (n.unbind(),
                    this.colors.forEach(function (o, l) {
                        return (o.index = l);
                    }),
                    this.state &&
                        this.setState({
            ...
            (r.prototype.setColors = function (t, n) {
                var o = this;
                (n === void 0 && (n = 0),
                    this.colors.forEach(function (l) {
                        return l.unbind();
                    }),
                    (this.colors = []),
            ...
            (r.prototype.on = function (t, n) {
                var o = this,
                    l = this.events;
                (Array.isArray(t) ? t : [t]).forEach(function (c) {
                    ((l[c] || (l[c] = [])).push(n),
                        o.deferredEvents[c] &&
                            (o.deferredEvents[c].forEach(function (s) {
                                n.apply(null, s);
                            }),
                            (o.deferredEvents[c] = [])));
                });
            ...
            (r.prototype.off = function (t, n) {
                var o = this;
                (Array.isArray(t) ? t : [t]).forEach(function (l) {
                    var c = o.events[l];
            ...
            (r.prototype.emit = function (t) {
                ...
                var c = this.activeEvents,
                    s = c.hasOwnProperty(t) ? c[t] : false;
                if (!s) {
                    c[t] = true;
                    var u = this.events[t] || [];
            ...
            (r.prototype.deferredEmit = function (t) {
                ...
                ((n = this).emit.apply(n, [t].concat(o)), (c[t] || (c[t] = [])).push(o));
            }),
            ...
            (r.prototype.onColorChange = function (t, n) {
                (this.setState({
                    ...
                    this.inputActive && ((this.inputActive = false), this.emit('input:change', t, n)),
            ...
            (r.prototype.emitInputEvent = function (t, n) {
                t === 0
                    ...
                    : t === 1
                      ...
                      : t === 2 && this.emit('input:end', this.color, n);
            }),
    ...
    function Nr(e, r, i, t, n, o) {
        e.current &&
            ((r.current = j.ColorPicker(e.current, i)),
            r.current.on('color:init', l => {
                n && n(l, o);
            }),
    ...
    const Ee = d.forwardRef(
        (
            {
                dimensions: e,
                colorLightUIComponent: r,
                colorLightSliderWidth: i,
                colorLightBorderWidth: t,
                colorLightBorderColor: n,
                colorWheelLightness: o,
                colorLightType: l,
                colorLightCtMin: c,
                colorLightCtMax: s,
                colorLightGamut: u,
                cctComponentNumber: h,
                onInputChange: a,
                onColorInit: f,
            },
            g,
        ) => {
            const { theme: y } = d.useContext(Ae),
                b = d.useRef(null),
                x = d.useRef(null),
                m = d.useRef(f),
                _ = d.useRef(a);
            ((m.current = f), (_.current = a));
            const w = d.useMemo(() => Wr(h, r, l, c, s), [h, r, l, c, s]),
                p = d.useMemo(() => zr(e, r, l), [e, r, l]),
                W = d.useMemo(() => At(e, r, i, l), [e, r, i, l]);
            return (
                d.useEffect(
                    () => (
                        Nr(
                            ...
                            (U, T) => {
                                var _a;
                                return (_a = _.current) == null ? void 0 : _a.call(_, U, T);
                            },
                            (U, T) => {
                                var _a;
                                return (_a = m.current) == null ? void 0 : _a.call(m, U, T);
                            },
                            h,
                        ),
                        Gr(g, x.current),
                ...
                }, [y.palette.primary.main, w, W, i, t, n, o]),
                v.jsx(D, {
                    ref: b,
                })
            );
    ...
    function ct(e, r, i) {
        ...
        const t = ie(
            ...
            r,
            i,
            (_a = r.colorLightBrightnessOidObject) == null ? void 0 : _a.maxValue,
        );
        t !== void 0 && (e.value = t);
    }
    function Z(e, r, i, t, n) {
        ...
        switch (r) {
            case 'cct': {
                if (n === 1) Mt(e, t, i);
                    ...
                    const o = ie(
                        ...
                        t,
                        i,
                        (_a = t.colorLightBrightnessOidObject) == null ? void 0 : _a.maxValue,
                    );
                    o !== void 0 && (e.value = o);
                }
                break;
            ...
            case 'rgbcct': {
                ...
                const o = i('colorLightRgbHexOid'),
                    l = typeof o == 'string' && o.trim().length > 0 ? o : '#ffffff';
                e.hexString = l;
                break;
            }
            case 'r/g/b':
            case 'r/g/b/cct': {
                if (t.colorLightRedOid && t.colorLightGreenOid && t.colorLightBlueOid) {
                    const o = Y('colorLightRedOid', t, i),
                        l = Y('colorLightGreenOid', t, i),
                        c = Y('colorLightBlueOid', t, i);
            ...
            case 'h/s/v/cct': {
                if (t.colorLightHueOid && t.colorLightSaturationOid && t.colorLightBrightnessOid) {
                    const o = Y('colorLightHueOid', t, i),
                        l = ie(
                            'colorLightSaturationOid',
                            t,
                            i,
                            (_b = t.colorLightSaturationOidObject) == null ? void 0 : _b.maxValue,
                        ),
                        c = ie(
                            'colorLightBrightnessOid',
                            t,
                            i,
                            (_c = t.colorLightBrightnessOidObject) == null ? void 0 : _c.maxValue,
                        );
    ...
    const Kr = (e, r) => (!e || !r ? true : !!r[e]),
        Yr = e => (e === 'kelvin' ? 2e3 : e === 'hexString' ? '#ffffff' : 0),
        we = (e, r) => {
            const i = r.value;
    ...
    function Zr() {
        ...
        const [e, r] = d.useState(false),
            ...
            { data: c } = at(''),
            s = d.useRef(null),
            u = Gt(s.current, (n.colorLightSliderWidth || 1) * 28),
            h = d.useRef(null),
            a = d.useRef(null),
            f = d.useRef(e),
            g = d.useRef(t.data);
        ...
        const y = d.useRef(l);
        y.current = l;
        const [b, x] = d.useState(false),
            m = d.useRef(false),
            _ = d.useRef(false),
            w = n.colorLightType === 'rgbcct' || n.colorLightType === 'r/g/b/cct' || n.colorLightType === 'h/s/v/cct',
            p = e && w ? 'cct' : n.colorLightType,
            { value: W, updateValue: U } = P('colorLightSwitchOid'),
            { value: T, hasBackendChange: Be, updateValue: ue } = P('colorLightTemperatureOid'),
            { updateValue: J, hasBackendChange: ee } = P('colorLightBrightnessOid'),
            { updateValue: de, hasBackendChange: He } = P('colorLightRgbHexOid'),
            { updateValue: fe, hasBackendChange: We } = P('colorLightRedOid'),
            { updateValue: ge, hasBackendChange: ze } = P('colorLightGreenOid'),
            { updateValue: ve, hasBackendChange: Ne } = P('colorLightBlueOid'),
            { updateValue: me, hasBackendChange: De } = P('colorLightHueOid'),
            { updateValue: pe, hasBackendChange: Fe } = P('colorLightSaturationOid'),
            Rt = ((_a = t.data.colorLightSwitchOidObject) == null ? void 0 : _a.type) === 'boolean',
            Ve = (C, k) => {
                Z(C, p, l, t.data, k);
            },
            Ge = d.useMemo(
                () => (C, k) => {
                    const be = (k == null ? void 0 : k.maxValue) === 254,
                        te = Math.round(C);
                    return be ? Math.round((C / 100) * 254) : te;
                },
                [],
            ),
            $e = d.useMemo(
                ...
                [ue, J, de, fe, ge, ve, me, pe],
            ),
            Ue = d.useMemo(
                () => (C, k, be) => {
                    if (!(!p || _.current || m.current)) {
                        _.current = true;
                        try {
                            const te = $e[p];
                            if (!te) return;
                            (te.forEach(_e => {
                                ...
                                (Bt && typeof R == 'number'
                                    ? (R = Ge(R, Qe))
                                    : typeof R == 'number' && (R = Math.round(R)),
                                    R == null && (R = Yr(Ke)),
                                    Tt(R));
                            }),
                                k === 1 && x(_e => !_e));
            ...
            Pt = d.useMemo(
                () => At(u, n.colorLightUIComponent, n.colorLightSliderWidth, p),
                [u, n.colorLightUIComponent, n.colorLightSliderWidth, p],
            ),
            Xe = d.useMemo(
                () => ({
                    dimensions: u,
        ...
        return (
            d.useEffect(() => {
                if (p !== 'cct' || !h.current || !a.current) return;
                const C = h.current.color,
                    k = a.current.color;
                if (b) {
                    m.current = true;
                    try {
            ...
            d.useEffect(() => {
                if (p !== 'cct' || !h.current || !a.current || !Be) return;
                const C = h.current.color,
                    k = a.current.color;
                if (T != null) {
                    m.current = true;
                    try {
                        ((C.kelvin = Number(T)), we(C, k));
                    } finally {
                        m.current = false;
                    }
                }
            ...
            d.useEffect(() => {
                if (!(e || !['rgb', 'rgbcct'].includes(p || '')) && !(!He || !h.current)) {
                    m.current = true;
                    try {
                        Z(h.current.color, p, l, t.data);
                    } finally {
                        m.current = false;
                    }
                }
            ...
            d.useEffect(() => {
                if (!(e || !['r/g/b', 'r/g/b/cct'].includes(p || '')) && !((!We && !ze && !Ne) || !h.current)) {
                    m.current = true;
                    try {
                        Z(h.current.color, p, l, t.data);
                    } finally {
            ...
            }, [e, p, We, ze, Ne, l, t.data]),
            d.useEffect(() => {
                if (!(e || !['h/s/v', 'h/s/v/cct'].includes(p || '')) && !((!De && !Fe && !ee) || !h.current)) {
                    m.current = true;
                    try {
                        Z(h.current.color, p, l, t.data);
                    } finally {
            ...
            d.useEffect(() => {
                ...
                m.current = true;
                try {
                    (Mt(C, g.current, y.current),
                        f.current === false && Number(T) !== Number(C.kelvin) && ue(Number(C.kelvin)),
                        we(C, k));
                } finally {
                    m.current = false;
                }
            ...
            d.useEffect(() => {
                if (!(f.current !== true || e || !w || !h.current)) {
                    m.current = true;
                    try {
                        Z(h.current.color, p, y.current, g.current);
                    } finally {
                        m.current = false;
                    }
                }
    ...
    It = class extends $t {
        ...
        renderWidgetBody(r) {
            ...
            return Ut(this.wrapContent(v.jsx(Jr, {})), t);
        }
    };
});
export { __tla, It as default };
