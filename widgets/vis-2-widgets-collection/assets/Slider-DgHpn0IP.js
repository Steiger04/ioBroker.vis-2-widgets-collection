...
let __tla = Promise.all([
    ...
    function Pe({ sliderRef: e, activeIndex: t, setActive: o }) {
        ...
        ((!((_a = e.current) == null ? void 0 : _a.contains(n.activeElement)) ||
            Number((_b = n == null ? void 0 : n.activeElement) == null ? void 0 : _b.getAttribute('data-index')) !==
                t) &&
            ((_c = e.current) == null ? void 0 : _c.querySelector(`[type="range"][data-index="${t}"]`).focus()),
            o && o(t));
    }
    function Te(e, t) {
        ...
        return (
            Ae === void 0 &&
                (typeof CSS < 'u' && typeof CSS.supports == 'function'
                    ? (Ae = CSS.supports('touch-action', 'none'))
                    : (Ae = true)),
            Ae
        );
    }
    function St(e) {
        const {
            ...
            v =
                M &&
                ((a, r, s) => {
                    const c = a.nativeEvent || a,
                        i = new c.constructor(c.type, c);
            ...
            te = Array.isArray(A);
        let b = te ? A.slice().sort(tt) : [A];
        b = b.map(a => (a == null ? u : de(a, u, f)));
        const ie =
                N === true && z !== null
                    ? [...Array(Math.floor((f - u) / z) + 1)].map((a, r) => ({
                          value: u + z * r,
                      }))
                    : N || [],
            m = ie.map(a => a.value),
                ...
                if (
                    ...
                    if (z != null) {
                        ...
                        const l = m[m.length - 1],
                            P = m.indexOf(c),
                            R = [w ? 'ArrowRight' : 'ArrowLeft', 'ArrowDown', 'PageDown', 'Home'],
                            g = [w ? 'ArrowLeft' : 'ArrowRight', 'ArrowUp', 'PageUp', 'End'];
                        R.includes(r.key)
                            ? P === 0
                                ? (i = m[0])
                                : (i = m[P - 1])
                            : g.includes(r.key) && (P === m.length - 1 ? (i = l) : (i = m[P + 1]));
                    }
                    i != null && he(r, i);
                }
        ...
        const W = ({ finger: a, move: r = false }) => {
                const { current: s } = d,
                    { width: c, height: i, bottom: l, left: P } = s.getBoundingClientRect();
                let R;
                (Y.startsWith('vertical') ? (R = (l - a.y) / i) : (R = (a.x - P) / c),
                    Y.includes('-reverse') && (R = 1 - R));
                let g;
            ...
            $ = _e(a => {
                ...
                (Q(-1), a.type === 'touchend' && Z(-1), q && q(a, le.current ?? s), (E.current = void 0), X());
            }),
            S = _e(a => {
                if (n) return;
                Qe() || a.preventDefault();
        ...
        const Ve = a => r => {
                var _a;
                if (((_a = a.onMouseDown) == null ? void 0 : _a.call(a, r), n || r.defaultPrevented || r.button !== 0))
                    return;
                r.preventDefault();
                const s = Ce(r, E);
                if (s !== false) {
        ...
        let ae;
        return (
            G === 'vertical' && (ae = w ? 'vertical-rl' : 'vertical-lr'),
            {
                active: V,
                axis: Y,
                axisProps: kt,
    ...
    Rt = B('span', {
        ...
        overridesResolver: (e, t) => {
            const { ownerState: o } = e;
            return [t.thumb, t[`thumbColor${F(o.color)}`], o.size !== 'medium' && t[`thumbSize${F(o.size)}`]];
        },
    })(
        se(({ theme: e }) => ({
            position: 'absolute',
    ...
    Et = e => {
        const { disabled: t, dragging: o, marked: n, orientation: p, track: w, classes: N, color: f, size: u } = e,
            L = {
                root: [
                    'root',
                    t && 'disabled',
                ...
                thumb: ['thumb', t && 'disabled', u && `thumbSize${F(u)}`, f && `thumbColor${F(f)}`],
                active: ['active'],
                disabled: ['disabled'],
    ...
    Vt = y.forwardRef(function (t, o) {
        const n = ut({
            ...
            p = dt(),
            {
                ...
                track: b = 'normal',
                value: ie,
                valueLabelDisplay: m = 'off',
                valueLabelFormat: D = Ze,
                ...re
            } = n,
            d = {
                ...n,
        ...
        const x = Et(d),
            ce = (v == null ? void 0 : v.root) ?? L.Root ?? Pt,
            ke = (v == null ? void 0 : v.rail) ?? L.Rail ?? Tt,
            ye = (v == null ? void 0 : v.track) ?? L.Track ?? At,
            Se = (v == null ? void 0 : v.thumb) ?? L.Thumb ?? Rt,
            xe = (v == null ? void 0 : v.valueLabel) ?? L.ValueLabel ?? It,
            ae = (v == null ? void 0 : v.mark) ?? L.Mark ?? Mt,
            we = (v == null ? void 0 : v.markLabel) ?? L.MarkLabel ?? zt,
            a = (v == null ? void 0 : v.input) ?? L.Input ?? 'input',
            r = (C == null ? void 0 : C.root) ?? M.root,
            s = (C == null ? void 0 : C.rail) ?? M.rail,
            c = (C == null ? void 0 : C.track) ?? M.track,
            i = (C == null ? void 0 : C.thumb) ?? M.thumb,
            l = (C == null ? void 0 : C.valueLabel) ?? M.valueLabel,
            P = (C == null ? void 0 : C.mark) ?? M.mark,
            R = (C == null ? void 0 : C.markLabel) ?? M.markLabel,
            g = (C == null ? void 0 : C.input) ?? M.input,
            H = O({
                elementType: ce,
                getSlotProps: Ne,
                externalSlotProps: r,
        ...
        return T.jsxs(ce, {
            ...
            children: [
                ...
                $.filter(h => h.value >= V && h.value <= E).map((h, k) => {
                    const Fe = Me(h.value, V, E),
                        Le = _[U].offset(Fe);
                    let j;
                    return (
                        b === false
                            ? (j = S.includes(h.value))
                            : (j =
                                  (b === 'normal' &&
                                      (W ? h.value >= S[0] && h.value <= S[S.length - 1] : h.value <= S[0])) ||
                                  (b === 'inverted' &&
                                      (W ? h.value <= S[0] || h.value >= S[S.length - 1] : h.value >= S[0]))),
                        T.jsxs(
                            y.Fragment,
