...
import { u as fe, d as ge, __tla as __tla_1 } from './useValueState-CqWHZ0NH.js';
import { v as c, __tla as __tla_2 } from './vis2CollectionWidget__loadShare__react__loadShare__-Cz8-6BjL.js';
import { S as xe, __tla as __tla_3 } from './Stack-CzOOYs5P.js';
import { F as Ce, __tla as __tla_4 } from './FormControlLabel-BAm8tbJK.js';
import { S as ve, __tla as __tla_5 } from './SwitchBase-Dz75iFvF.js';
...
let __tla = Promise.all([
    ...
    function E(e) {
        const { checked: o = false, classes: a = {}, fontSize: s } = e,
            r = {
                ...e,
                checked: o,
            };
    ...
    const V = Q('MuiRadio', ['root', 'checked', 'disabled', 'colorPrimary', 'colorSecondary', 'sizeSmall']),
        Pe = e => {
            const { classes: o, color: a, size: s } = e,
                r = {
                    root: ['root', `color${b(a)}`, s !== 'medium' && `size${b(s)}`],
                };
            return {
                ...o,
                ...te(r, Ie, o),
        ...
        Be = S(ve, {
            ...
            overridesResolver: (e, o) => {
                ...
                return [o.root, a.size !== 'medium' && o[`size${b(a.size)}`], o[`color${b(a.color)}`]];
            },
        })(
            T(({ theme: e }) => ({
                        ...
                        style: {
                            '&:hover': {
                                backgroundColor: e.vars
                                    ...
                                    : W(e.palette.action.active, e.palette.action.hoverOpacity),
                            },
                        },
                    },
                            ...
                            style: {
                                '&:hover': {
                                    backgroundColor: e.vars
                                        ...
                                        : W(e.palette[o].main, e.palette.action.hoverOpacity),
                                },
                            },
                        })),
                    ...Object.entries(e.palette)
    ...
    function $e() {
        const [e, o] = c.useState(null),
            ...
            { data: p, states: u } = se('oid'),
            { value: g, updateValue: k } = fe('oid'),
            h = r == null ? void 0 : r.type,
            w = ['boolean', 'number', 'string', 'mixed'].includes(h ?? ''),
            l = n.data.radioOrientation === 'horizontal',
            d = a && u.length > 0 ? a / u.length : void 0,
            x = i => {
                k(i.target.value);
            };
        return t.jsxs(le, {
                                ...
                                label: n.data.hideLabels
                                    ...
                                    : t.jsx(de, {
                                          ...
                                          sx: {
                                              ...
                                              textAlign: 'left',
                                              background: G(i.textColor),
                                              WebkitBackgroundClip: 'text',
                                              backgroundClip: 'text',
                                              color: G(i.textColor) ? 'transparent' : i.textColor,
                                          },
    ...
    H = class extends ue {
            ...
            return {
                ...
                visAttrs: [
                    ...
                    },
                    {
                        name: 'radioGroup',
                        label: 'radio_group',
                        fields: [...he(['string', 'number', 'boolean', 'mixed']), ...ge(), ...Oe()],
                    },
                    {
                        name: 'values',
                        label: 'values',
        ...
        renderWidgetBody(o) {
            ...
            return (
                o.widget.data.noCard || o.widget.usedInWidget
                    ? (this.wrappedCollectionContent = false)
                    : (this.wrappedCollectionContent = true),
                me(this.wrapContent(t.jsx($e, {})), a)
            );
        }
    };
});
export { __tla, H as default };
