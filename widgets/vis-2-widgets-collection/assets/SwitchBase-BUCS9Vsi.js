...
import { g as J, a as K, ax as Q, v as V, k as C, s as F, j as k, x as X, e as Y, B as Z, r as ee, __tla as __tla_1 } from "./usePopoverPositioning-CABAc1cn.js";
let ie;
let __tla = Promise.all([
  ...
  ie = H.forwardRef(function(s, l) {
    const { autoFocus: d, checked: n, checkedIcon: c, defaultChecked: u, disabled: b, disableFocusRipple: h = false, edge: y = false, icon: x, id: R, inputProps: _, inputRef: I, name: v, onBlur: g, onChange: f, onFocus: m, readOnly: z, required: j = false, tabIndex: U, type: i, value: S, slots: E = {}, slotProps: L = {}, ...M } = s, [B, N] = Q({
      controlled: n,
      default: !!u,
      name: "SwitchBase",
      state: "checked"
