...
let __tla = (async () => {
  i = {
    "./StateCollectionWidget": async () => {
      const t = await o(() => import("./StateCollectionWidget-CFnUb8nu.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./SliderCollectionWidget": async () => {
      const t = await o(() => import("./SliderCollectionWidget-Ckzgfk34.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./ButtonGroupCollectionWidget": async () => {
      const t = await o(() => import("./ButtonGroupCollectionWidget-BhQYQ67A.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./SwitchCollectionWidget": async () => {
      const t = await o(() => import("./SwitchCollectionWidget-Dxh__i-X.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./CheckboxCollectionWidget": async () => {
      const t = await o(() => import("./CheckboxCollectionWidget-8mS_ONUj.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./DialogCollectionWidget": async () => {
      const t = await o(() => import("./DialogCollectionWidget-DrQR93H2.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./SelectCollectionWidget": async () => {
      const t = await o(() => import("./SelectCollectionWidget-B_M3Pnsj.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./RadioGroupCollectionWidget": async () => {
      const t = await o(() => import("./RadioGroupCollectionWidget-Ck2sfcSd.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./GaugeCollectionWidget": async () => {
      const t = await o(() => import("./GaugeCollectionWidget-BtcMLvTL.js").then(async (m) => {
        await m.__tla;
        return m;
    ...
    "./Light2CollectionWidget": async () => {
      const t = await o(() => import("./Light2CollectionWidget-ItjRgY4p.js").then(async (m) => {
        await m.__tla;
        return m;
