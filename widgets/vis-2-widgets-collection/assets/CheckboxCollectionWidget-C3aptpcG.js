...
let __tla = Promise.all([
    ...
    function T() {
        const i = A.useContext(C),
            { widget: t, theme: l } = i,
            b = t.data.oidObject,
            { data: e } = I('oid'),
            { value: a, updateValue: g } = j('oid'),
            u = (b == null ? void 0 : b.type) === 'boolean',
            y = L(a, t, e);
        return o.jsxs(v, {
            isValidType: u,
            data: e,
    ...
    p = class extends f {
        ...
        renderWidgetBody(t) {
            ...
            return (
                ...
                k(this.wrapContent(o.jsx(T, {})), l)
            );
        }
    };
});
export { __tla, p as default };
