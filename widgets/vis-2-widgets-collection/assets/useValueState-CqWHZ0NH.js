import { j as rt, C as nt, n as H, q as it, __tla as __tla_0 } from './useData-CoMv8b7s.js';
...
let __tla = Promise.all([
    ...
    function W(e, r) {
        var t = {
            ...
            i,
            o,
            u = Object.create((typeof Iterator == 'function' ? Iterator : Object).prototype);
        return (
            (u.next = a(0)),
            (u.throw = a(1)),
            (u.return = a(2)),
            ...
            for (; u && ((u = 0), s[0] && (t = 0)), t; )
                try {
                    if (
                        ((n = 1),
                        i &&
                            (o = s[0] & 2 ? i.return : s[0] ? i.throw || ((o = i.return) && o.call(i), 0) : i.next) &&
                            !(o = o.call(i, s[1])).done)
                    )
                        return o;
...
` +
  ...
  `)
    ...
    var ct = {
        ...
        at = {
            setTimeout: function (e, r) {
                ...
                return setTimeout.apply(void 0, j([e, r], P(t)));
            },
    ...
    var D = (function (e) {
            ...
            return (
                ...
                (r.prototype.unsubscribe = function () {
                    this.closed ||
                        ((this.isStopped = true), e.prototype.unsubscribe.call(this), (this.destination = null));
                }),
    ...
    var mt = (function (e) {
        ...
        G = (function (e) {
            ...
            return (
                ...
                (r.prototype._subscribe = function (t) {
                    var n, i;
                    return (i = (n = this.source) === null || n === void 0 ? void 0 : n.subscribe(t)) !== null &&
                        i !== void 0
                        ? i
                        : J;
                }),
        ...
        q = {
            setInterval: function (e, r) {
                for (var t = [], n = 2; n < arguments.length; n++) t[n - 2] = arguments[n];
                return setInterval.apply(void 0, j([e, r], P(t)));
            },
            ...
            return (
                (r.prototype.schedule = function (t, n) {
                    ...
                    var o = this.id,
                        u = this.scheduler;
                    return (
                        o != null && (this.id = this.recycleAsyncId(u, o, n)),
                        (this.pending = true),
                        (this.delay = n),
                        (this.id = (i = this.id) !== null && i !== void 0 ? i : this.requestAsyncId(u, this.id, n)),
                        this
                    );
                }),
            ...
            return W(this, function (u) {
                switch (u.label) {
                    ...
                    case 2:
                        return [4, g(t.read())];
                    case 3:
                        return ((n = u.sent()), (i = n.value), (o = n.done), o ? [4, g(void 0)] : [3, 5]);
                    case 4:
                        return [2, u.sent()];
                    case 5:
                        return [4, g(i)];
    ...
    function Yt(e, r) {
        ...
        return ot(this, void 0, void 0, function () {
            ...
            return W(this, function (c) {
                switch (c.label) {
                    case 0:
                        (c.trys.push([0, 5, 6, 11]), (t = st(e)), (c.label = 1));
                    case 1:
                        return [4, t.next()];
                    case 2:
                        if (((n = c.sent()), !!n.done)) return [3, 4];
                        if (((u = n.value), r.next(u), r.closed)) return [2];
                        c.label = 3;
                    case 3:
                        return [3, 1];
                    case 4:
    ...
    function zt({ oidObject: e, data: { sampleInterval: r, sampleIntervalValue: t, delay: n } }) {
        const { setValue: i } = m.useContext(H),
            o = m.useRef(),
            u = m.useRef(null),
            a = m.useRef(i);
        a.current = i;
        const c = e == null ? void 0 : e._id,
            s = m.useMemo(() => {
                const l = Number(t),
                    f = Number(n);
                return r ? l : f;
        ...
        return (
            m.useEffect(() => {
                ...
                const l = o.current;
                return (
                    u.current && u.current.unsubscribe(),
                    (u.current = l
                        .pipe(
                            r
                                ? Wt(s, void 0, {
    ...
    te = e => {
        const { setState: r, widget: t, getPropertyValue: n, values: i } = m.useContext(H),
            { data: o } = it('oid'),
            u = t.data[`${e}Object`],
            a = n(e),
            c = m.useRef({
            ...
            s = m.useRef(0),
            l = Number(o.delay ?? t.data.delay) || 300,
            f = (u == null ? void 0 : u._id) ? i[`${u._id}.lc`] : void 0,
            v = (u == null ? void 0 : u._id) ? i[`${u._id}.val`] : void 0,
            h = m.useMemo(() => {
                ...
                const S = c.current.lc !== f,
                    b = Kt(c.current.value, v);
                return (
                    (c.current = {
                        lc: f,
                        value: v,
