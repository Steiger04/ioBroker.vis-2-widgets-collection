...
import { u as ot, d as Ct, __tla as __tla_1 } from './useValueState-CqWHZ0NH.js';
import { v as l, __tla as __tla_2 } from './vis2CollectionWidget__loadShare__react__loadShare__-Cz8-6BjL.js';
import { C as St, __tla as __tla_3 } from './Close-CQt1dGJP.js';
import { S as It, __tla as __tla_4 } from './Slider-DgHpn0IP.js';
import { g as jt, l as W, __tla as __tla_5 } from './listItemTextClasses-CJ06hn_z.js';
import { D as kt, a as wt, b as Pt, __tla as __tla_6 } from './DialogTitle-CJWtNrVp.js';
import { S as Lt, __tla as __tla_7 } from './Stack-CzOOYs5P.js';
import { u as Rt, __tla as __tla_8 } from './useHtmlValue-3ISCcM5X.js';
import { B as At, __tla as __tla_9 } from './Button-BOWf2z70.js';
...
let __tla = Promise.all([
    ...
    E('MuiAvatar', ['root', 'colorDefault', 'circular', 'rounded', 'square', 'img', 'fallback']);
    const Bt = t => {
    ...
    const O = E('MuiListItemButton', [
        ...
        Wt = t => {
            const { alignItems: e, classes: o, dense: n, disabled: s, disableGutters: d, divider: r, selected: i } = t,
                f = N(
                    {
                        root: [
                            'root',
            ...
            H(({ theme: t }) => ({
                ...
                [`&.${O.selected}`]: {
                    backgroundColor: t.vars
                        ...
                        : G(t.palette.primary.main, t.palette.action.selectedOpacity),
                    [`&.${O.focusVisible}`]: {
                        backgroundColor: t.vars
                ...
                [`&.${O.selected}:hover`]: {
                    backgroundColor: t.vars
                        ...
                        : G(t.palette.primary.main, t.palette.action.selectedOpacity + t.palette.action.hoverOpacity),
                    '@media (hover: none)': {
                        backgroundColor: t.vars
                            ? `rgba(${t.vars.palette.primary.mainChannel} / ${t.vars.palette.action.selectedOpacity})`
                            : G(t.palette.primary.main, t.palette.action.selectedOpacity),
    ...
    const Yt = (t, e) => {
        ...
        Qt = l.forwardRef(function (e, o) {
            const n = $({
                ...
                }),
                {
                    ...
                    ContainerProps: { className: k, ...x } = {},
                    dense: b = false,
                    disableGutters: h = false,
                    disablePadding: w = false,
                    divider: u = false,
                    secondaryAction: p,
                    slotProps: j = {},
                    slots: S = {},
                ...
                v = l.useRef(null),
                I = l.Children.toArray(d),
                L = I.length && ct(I[I.length - 1], ['ListItemSecondaryAction']),
                T = {
                    ...n,
                    alignItems: s,
                    dense: m.dense,
            ...
            let M = i || 'li';
            return L
                ? ((M = !_.component && !i ? 'div' : M),
                  C === 'li' && (M === 'li' ? (M = 'div') : _.component === 'li' && (_.component = 'div')),
                  a.jsx(R.Provider, {
                      value: m,
                      children: a.jsxs(Jt, {
                          as: C,
        ...
        Zt = t => {
            ...
            return N(
                {
                    root: ['root', o && 'inset', d && 'dense', n && s && 'multiline'],
                    primary: ['primary'],
                    secondary: ['secondary'],
                },
                jt,
        ...
        oe = () => [
            ...
            },
            {
                ...
                hidden: (t, e) => {
                    ...
                    return (
                        !t.values_count &&
                        !Object.keys(((_a = t.oidObject) == null ? void 0 : _a.commonStates) || {}).length
                    );
                },
            },
            {
        ...
        se = ({ widgetStates: t, data: e, open: o, closeHandler: n }) => {
            const { widget: s, getPropertyValue: d } = l.useContext(et),
                r = s.data.oidObject,
                i = s.data.onlyStates,
                [g, f] = l.useState(() => {
                    const c = d('oid');
                ...
                { updateValue: C } = ot('oid'),
                k = l.useMemo(() => {
                    const c = r == null ? void 0 : r.commonStates,
                        m = r == null ? void 0 : r.type,
                        v = r == null ? void 0 : r.name,
                        I = r == null ? void 0 : r.minValue,
                        L = r == null ? void 0 : r.maxValue;
                    return {
                        commonStates: c,
                        oidType: m,
                        oidName: v,
                ...
                p = l.useMemo(() => {
                    ...
                    return c === 'number' && !i && v !== void 0 && I !== void 0
                        ? a.jsx(B, {
                              sx: {
                                  px: 3,
                              },
                ...
                j = l.useMemo(
                    () =>
                        !t || !Object.keys(t).length
                            ? null
                            : a.jsx(dt, {
                                  children: Object.entries(t).map(([c, m]) =>
                                      a.jsx(
                                          Qt,
                                          {
                                              disablePadding: true,
                ...
                S = l.useMemo(() => e.header || k.oidName || 'Change Value', [e.header, k.oidName]),
                y = l.useMemo(() => t && Object.keys(t).length > 0, [t]);
            return a.jsxs(kt, {
                open: o,
                onClose: h,
                maxWidth: 'xs',
    ...
    function ae() {
        const t = l.useContext(et),
            { widget: e, theme: o } = t,
            n = e.data.oidObject,
            { data: s, widgetStates: d, states: r } = gt('oid'),
            { value: i, updateValue: g } = ot('oid'),
            [f, C] = l.useState(false),
            k = n == null ? void 0 : n.type,
            x = e.data.onlyStates,
            b = Rt(i, e, s),
            h = b != null ? String(b) : '',
            w = () => {
            ...
            p = l.useCallback(() => {
                ...
                switch (r.length) {
                    case 1:
                        ...
                        break;
                    case 2:
                        e.data.value1 !== void 0 &&
                            e.data.value2 !== void 0 &&
                            (!e.data.statePushButton && String(i) === String(e.data.value1)
                                ? g(e.data.value2)
                                : g(e.data.value1));
                        break;
                    default:
            ...
            }, [i, x, r.length, e.data.statePushButton, e.data.value1, e.data.value2, g]),
            j = a.jsx(At, {
                ...
                children: a.jsxs(B, {
                    ...
                    children: [
                        !e.data.noIcon &&
                            ...
                            (() => {
                                const y = s.icon,
                                    c = s.iconColor || o.palette.primary.main,
                                    m = s.forceColorMask,
                                    v = yt(y, c, m);
                                return a.jsx(B, {
                                    sx: {
            ...
            S = ['boolean', 'number', 'string', 'mixed'].includes(k ?? '');
    ...
    at = class extends xt {
            ...
            return {
                ...
                visAttrs: [
                    ...
                    },
                    {
                        name: 'button',
                        label: 'group_button',
                        fields: [...bt(['string', 'number', 'boolean', 'mixed']), ...Ct(), ...oe()],
                    },
                    {
                        name: 'values',
                        label: 'values',
        ...
        renderWidgetBody(e) {
            ...
            return (
                e.widget.data.noCard || e.widget.usedInWidget
                    ? (this.wrappedCollectionContent = false)
                    : (this.wrappedCollectionContent = true),
                ht(this.wrapContent(a.jsx(ae, {})), o)
            );
        }
    };
});
export { __tla, at as default };
