const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            './assets/index-BEpFHtMA.js',
            './assets/_commonjsHelpers-Cpj98o6Y.js',
            './assets/index-UMzeul1g.js',
            './assets/vis2CollectionWidget__loadShare__react__loadShare__-Cz8-6BjL.js',
            './assets/vis2CollectionWidget__mf_v__runtimeInit__mf_v__-Cugi9Gwb.js',
        ]),
) => i.map(i => d[i]);
import exposesMap, { __tla as __tla_0 } from './assets/virtualExposes-DkDVPs8E.js';
...
let __tla = Promise.all([
    ...
    function isDebugMode() {
        return typeof process < 'u' && define_process_env_default && define_process_env_default.FEDERATION_DEBUG
            ? !!define_process_env_default.FEDERATION_DEBUG
    ...
    const getProcessEnv = function () {
        ...
        LOG_CATEGORY$1 = '[ Federation Runtime ]',
        parseEntry = (t, e, r = SEPARATOR) => {
            const o = t.split(r),
                n = getProcessEnv().NODE_ENV === 'development' && e,
                a = '*',
                s = i => i.startsWith('http') || i.includes(MANIFEST_EXT);
            if (o.length >= 2) {
                let [i, ...c] = o;
                t.startsWith(r) && ((i = o.slice(0, 2).join(r)), (c = [n || o.slice(2).join(r)]));
                let l = n || c.join(r);
                return s(l)
                    ? {
                          name: i,
        ...
        generateExposeFilename = (t, e) => {
            ...
            return (
                ...
                encodeName(r, '__federation_expose_', e)
            );
        },
        generateShareFilename = (t, e) => (t ? encodeName(t, '__federation_shared_', e) : ''),
        getResourceUrl = (t, e) => {
            if ('getPublicPath' in t) {
                let r;
                return (
                    t.getPublicPath.startsWith('function')
                        ? (r = new Function('return ' + t.getPublicPath)()())
                        : (r = new Function(t.getPublicPath)()),
                    `${r}${e}`
                );
            } else
                return 'publicPath' in t
                    ? !isBrowserEnv() && !isReactNativeEnv() && 'ssrPublicPath' in t
                        ? `${t.ssrPublicPath}${e}`
                        : `${t.publicPath}${e}`
                    : (console.warn('Cannot get resource URL. If in debug mode, please ignore.', t, e), '');
        },
        assert$1 = (t, e) => {
            t || error$1(e);
        },
    ...
    function generateSnapshotFromManifest(t, e = {}) {
        ...
        const s = () =>
                'publicPath' in t.metaData
                    ? t.metaData.publicPath === 'auto' && n
                        ? inferAutoPublicPath(n)
            ...
            (c =
                ((_a = t.remotes) == null
                    ...
                    : _a.reduce((E, b) => {
                          ...
                          return (
                              i.includes(S) ? (R = o[S]) : 'version' in b ? (R = b.version) : (R = b.entry),
                              (E[S] = {
                                  matchedVersion: R,
                              }),
                              E
        ...
        const {
                remoteEntry: { path: l, name: d, type: h },
                types: u = {
                    path: '',
                    name: '',
                    zip: '',
    ...
    function getManifestFileName(t) {
        ...
        let e = typeof t == 'boolean' ? '' : t.filePath || '',
            r = typeof t == 'boolean' ? '' : t.fileName || '';
        const o = '.json',
            n = c => (c.endsWith(o) ? c : `${c}${o}`),
            a = (c, l) => c.replace(o, `${l}${o}`),
            s = r ? n(r) : ManifestFileName,
            i = r ? a(s, '-stats') : StatsFileName;
        return {
...
`)}`
    ...
    class Logger {
        ...
        emit(e, r) {
            const o = this.delegate,
                a = isDebugMode() ? captureStackTrace() : void 0,
                s = a ? [...r, a] : r,
                i = (() => {
                    switch (e) {
                        case 'log':
    ...
    function createInfrastructureLogger(t) {
        ...
        return (
            Object.defineProperty(e, '__mf_infrastructure_logger__', {
                value: true,
                enumerable: false,
                configurable: false,
            }),
    ...
    function bindLoggerToCompiler(t, e, r) {
        if (t.__mf_infrastructure_logger__ && (e == null ? void 0 : e.getInfrastructureLogger))
            try {
    ...
    function createScript(t) {
        ...
        if (!e) {
            ...
            ((e = document.createElement('script')),
                (e.type = (i == null ? void 0 : i.type) === 'module' ? 'module' : 'text/javascript'));
            let c;
            (t.createScriptHook &&
                ((c = t.createScriptHook(t.url, t.attrs)),
                c instanceof HTMLScriptElement
                    ? (e = c)
                    : typeof c == 'object' &&
                      ('script' in c && c.script && (e = c.script), 'timeout' in c && c.timeout && (o = c.timeout))),
                e.src || (e.src = t.url),
                i &&
                    !c &&
                    Object.keys(i).forEach(l => {
                        e &&
                            (l === 'async' || l === 'defer'
                                ? (e[l] = i[l])
                                : e.getAttribute(l) || e.setAttribute(l, i[l]));
                    }));
        }
        const s = async (i, c) => {
            clearTimeout(n);
            const l = () => {
                (c == null ? void 0 : c.type) === 'error'
                    ? (t == null ? void 0 : t.onErrorCallback) && (t == null ? void 0 : t.onErrorCallback(c))
                    : (t == null ? void 0 : t.cb) && (t == null ? void 0 : t.cb());
            };
            if (
                e &&
                ((e.onerror = null),
        ...
        return (
            (e.onerror = s.bind(null, e.onerror)),
            (e.onload = s.bind(null, e.onload)),
            (n = setTimeout(() => {
    ...
    function createLink(t) {
        ...
        if (!e) {
            ...
            let a;
            const s = t.attrs;
            (t.createLinkHook && ((a = t.createLinkHook(t.url, s)), a instanceof HTMLLinkElement && (e = a)),
                s &&
                    !a &&
        ...
        const n = (a, s) => {
            const i = () => {
                (s == null ? void 0 : s.type) === 'error'
                    ? (t == null ? void 0 : t.onErrorCallback) && (t == null ? void 0 : t.onErrorCallback(s))
                    : (t == null ? void 0 : t.cb) && (t == null ? void 0 : t.cb());
            };
            if (
                e &&
        ...
        return (
            (e.onerror = n.bind(null, e.onerror)),
            (e.onload = n.bind(null, e.onload)),
            {
                link: e,
                needAttach: r,
            }
    ...
    function importNodeModule(t) {
        ...
        const r = new Function('name', 'return import(name)')(t)
            .then(o => o)
            .catch(o => {
    ...
    const loadNodeFetch = async () => {
        ...
        lazyLoaderHookFetch = async (t, e, r) => {
            ...
            return !n || !(n instanceof Response)
                ? (typeof fetch > 'u' ? await loadNodeFetch() : fetch)(t, e || {})
                : n;
        },
        createScriptNode =
            typeof ENV_TARGET > 'u' || ENV_TARGET !== 'web'
                ? (url, cb, attrs, loaderHook) => {
                      ...
                      const getFetch = async () =>
                              (loaderHook == null ? void 0 : loaderHook.fetch)
                                  ? (t, e) => lazyLoaderHookFetch(t, e, loaderHook)
                                  : typeof fetch > 'u'
                                    ? loadNodeFetch()
                                    : fetch,
                                      ...
                                      script = new vm.Script(
...
})`,
                                          {
                                              ...
                                              importModuleDynamically:
                                                  ((_a = vm.constants) == null
                                                      ? void 0
                                                      : _a.USE_MAIN_CONTEXT_DEFAULT_LOADER) ?? importNodeModule,
                                          },
                                      );
                          ...
                          createScriptNode(
                              ...
                              (n, a) => {
                                  ...
                                  if (n) o(n);
                                      ...
                                      const s =
                                              ((_a = e == null ? void 0 : e.attrs) == null ? void 0 : _a.globalName) ||
                                              `__FEDERATION_${(_b = e == null ? void 0 : e.attrs) == null ? void 0 : _b.name}:custom__`,
                                          i = (globalThis[s] = a);
                                      r(i);
                                  }
                              },
    ...
    async function loadModule(t, e) {
        ...
        const { fetch: r, vm: o } = e,
            a = await (await r(t)).text(),
            s = new o.SourceTextModule(a, {
        ...
        return (
            esmModuleCache.set(t, s),
            await s.link(async i => {
...
`)
    ...
    function error(t) {
        throw t instanceof Error
            ? (t.message.startsWith(LOG_CATEGORY) || (t.message = `${LOG_CATEGORY}: ${t.message}`), t)
            : new Error(`${LOG_CATEGORY}: ${t}`);
    }
    function warn(t) {
        (t instanceof Error && (t.message.startsWith(LOG_CATEGORY) || (t.message = `${LOG_CATEGORY}: ${t.message}`)),
            logger.warn(t));
    }
    ...
    function getRemoteEntryInfoFromSnapshot(t) {
        ...
        return sdk.isBrowserEnv() || sdk.isReactNativeEnv()
            ? 'remoteEntry' in t
                ? {
                      url: t.remoteEntry,
    ...
    function setGlobalDefaultVal(t) {
        (includeOwnProperty(t, '__VMOK__') &&
            ...
            (t.__FEDERATION__.__GLOBAL_PLUGIN__ ??= []),
            (t.__FEDERATION__.__INSTANCES__ ??= []),
            (t.__FEDERATION__.moduleInfo ??= {}),
            (t.__FEDERATION__.__SHARE__ ??= {}),
            (t.__FEDERATION__.__MANIFEST_LOADING__ ??= {}),
            (t.__FEDERATION__.__PRELOADED_MAP__ ??= /* @__PURE__ */ new Map()));
    }
    ...
    function resetFederationGlobalInfo() {
        ((CurrentGlobal.__FEDERATION__.__GLOBAL_PLUGIN__ = []),
            ...
            Object.keys(globalLoading).forEach(t => {
    ...
    function setGlobalFederationConstructor(t, e = sdk.isDebugMode()) {
        e &&
            ((CurrentGlobal.__FEDERATION__.__DEBUG_CONSTRUCTOR__ = t),
    ...
    const getGlobalSnapshot = () => nativeGlobal.__FEDERATION__.moduleInfo,
        getTargetSnapshotInfoByModuleInfo = (t, e) => {
            const r = getFMId(t),
                o = getInfoWithoutType(e, r).value;
            if ((o && !o.version && 'version' in t && t.version && (o.version = t.version), o)) return o;
            if ('version' in t && t.version) {
                const { version: n, ...a } = t,
                    s = getFMId(a),
                    i = getInfoWithoutType(nativeGlobal.__FEDERATION__.moduleInfo, s).value;
                if ((i == null ? void 0 : i.version) === n) return i;
            }
        },
        getGlobalSnapshotInfoByModuleInfo = t =>
            getTargetSnapshotInfoByModuleInfo(t, nativeGlobal.__FEDERATION__.moduleInfo),
        ...
        registerGlobalPlugins = t => {
            ...
            t.forEach(r => {
                e.findIndex(o => o.name === r.name) === -1
                    ? e.push(r)
                    : warn(`The plugin ${r.name} has been registered.`);
            });
        },
        getGlobalHostPlugins = () => nativeGlobal.__FEDERATION__.__GLOBAL_PLUGIN__,
        getPreloaded = t => CurrentGlobal.__FEDERATION__.__PRELOADED_MAP__.get(t),
        setPreloaded = t => CurrentGlobal.__FEDERATION__.__PRELOADED_MAP__.set(t, true),
    ...
    function parseCarets(t) {
        return t
            ...
            .split(/\s+/)
            .map(e =>
                e.replace(parseRegex(caret), (r, o, n, a, s) =>
                    isXVersion(o)
                        ? ''
                        : isXVersion(n)
                          ? `>=${o}.0.0 <${Number(o) + 1}.0.0-0`
                          : isXVersion(a)
                            ? o === '0'
                                ? `>=${o}.${n}.0 <${o}.${Number(n) + 1}.0-0`
                                : `>=${o}.${n}.0 <${Number(o) + 1}.0.0-0`
                            : s
                              ? o === '0'
                                  ? n === '0'
                                      ? `>=${o}.${n}.${a}-${s} <${o}.${n}.${Number(a) + 1}-0`
                                      : `>=${o}.${n}.${a}-${s} <${o}.${Number(n) + 1}.0-0`
                                  : `>=${o}.${n}.${a}-${s} <${Number(o) + 1}.0.0-0`
                              : o === '0'
                                ? n === '0'
                                    ? `>=${o}.${n}.${a} <${o}.${n}.${Number(a) + 1}-0`
                                    : `>=${o}.${n}.${a} <${o}.${Number(n) + 1}.0-0`
                                : `>=${o}.${n}.${a} <${Number(o) + 1}.0.0-0`,
                ),
            )
            .join(' ');
    }
    function parseTildes(t) {
        return t
            ...
            .split(/\s+/)
            .map(e =>
                e.replace(parseRegex(tilde), (r, o, n, a, s) =>
                    isXVersion(o)
                        ? ''
                        : isXVersion(n)
                          ? `>=${o}.0.0 <${Number(o) + 1}.0.0-0`
    ...
    function parseXRanges(t) {
        return t
            .split(/\s+/)
            .map(e =>
                e.trim().replace(parseRegex(xRange), (r, o, n, a, s, i) => {
                    const c = isXVersion(n),
                        l = c || isXVersion(a),
                        d = l || isXVersion(s);
                    return (
                        o === '=' && d && (o = ''),
                        ...
                        c
                            ...
                            : o && d
                              ? (l && (a = 0),
                                ...
                                o === '>'
                                    ? ((o = '>='),
                                      l ? ((n = Number(n) + 1), (a = 0), (s = 0)) : ((a = Number(a) + 1), (s = 0)))
                                    : o === '<=' && ((o = '<'), l ? (n = Number(n) + 1) : (a = Number(a) + 1)),
                                o === '<' && (i = '-0'),
                                `${o + n}.${a}.${s}${i}`)
                              : l
                                ? `>=${n}.0.0${i} <${Number(n) + 1}.0.0-0`
                                : d
                                  ? `>=${n}.${a}.0${i} <${n}.${Number(a) + 1}.0-0`
                                  : r
                    );
                }),
            )
    ...
    function getRegisteredShare(t, e, r, o) {
        if (!t) return;
        const { shareConfig: n, scope: a = DEFAULT_SCOPE, strategy: s } = r,
            i = Array.isArray(a) ? a : [a];
        for (const c of i)
            if (n && t[c] && t[c][e]) {
                const { requiredVersion: l } = n,
                    h = getFindShareFunction(s)(t, c, e),
                    u = () => {
                        if (n.singleton) {
    ...
    function getTargetSharedOptions(t) {
        const { pkgName: e, extraOptions: r, shareInfos: o } = t,
            n = s => {
                if (!s) return;
                const i = {};
                s.forEach(d => {
            ...
            try {
                e
                    ...
                    : typeof FEDERATION_ALLOW_NEW_FUNCTION < 'u'
                      ? new Function('callbacks', `import("${t}")${importCallback}`)([r, o])
                      : import(t)
                            .then(async m => {
                                await m.__tla;
                                return m;
            ...
            try {
                e
                    ...
                    : typeof __system_context__ > 'u'
                      ? System.import(t).then(r).catch(o)
                      : new Function('callbacks', `System.import("${t}")${importCallback}`)([r, o]);
            } catch (n) {
                o(n);
            }
        });
    ...
    async function loadEntryScript({ name: t, globalName: e, entry: r, loaderHook: o, getEntryUrl: n }) {
        ...
        return sdk
            ...
            .then(() => handleRemoteEntryLoaded(t, e, r))
            .catch(i => {
                throw (
                    assert(
                        void 0,
    ...
    async function loadEntryNode({ remoteInfo: t, loaderHook: e }) {
        const { entry: r, entryGlobalName: o, name: n, type: a } = t,
            { entryExports: s } = getRemoteEntryExports(n, o);
        return (
            s ||
            sdk
                .loadScriptNode(r, {
                ...
                .then(() => handleRemoteEntryLoaded(n, o, r))
                .catch(i => {
                    throw i;
                })
        );
    ...
    async function getRemoteEntry(t) {
        const { origin: e, remoteEntryExports: r, remoteInfo: o, getEntryUrl: n, _inErrorHandling: a = false } = t,
            s = getRemoteEntryUniqueKey(o);
        if (r) return r;
        if (!globalLoading[s]) {
            ...
            globalLoading[s] = i
                ...
                .then(
                    l =>
                        l ||
                        ((typeof ENV_TARGET < 'u' ? ENV_TARGET === 'web' : sdk.isBrowserEnv())
                            ? loadEntryDom({
                                  remoteInfo: o,
                                  remoteEntryExports: r,
                                  loaderHook: c,
 ...
 ${sdk.safeToString(this.remoteInfo)}`,
        ...
        async get(e, r, o, n) {
            ...
            if (!this.inited) {
                const h = this.host.shareScopeMap,
                    u = Array.isArray(this.remoteInfo.shareScope)
                        ? this.remoteInfo.shareScope
                        : [this.remoteInfo.shareScope];
                (u.length || u.push('default'),
                    u.forEach(y => {
                        h[y] || (h[y] = {});
                    }));
                const p = h[u[0]],
                ...
                (typeof (s == null ? void 0 : s.init) > 'u' &&
                    ...
                    await s.init(m.shareScope, m.initScope, m.remoteEntryInitOptions),
            ...
            const c = processModuleAlias(this.remoteInfo.name, r),
                l = this.wraperFactory(i, c);
            return a ? await l() : l;
        }
        wraperFactory(e, r) {
            function o(n, a) {
                n &&
                    ...
                    !Object.getOwnPropertyDescriptor(n, /* @__PURE__ */ Symbol.for('mf_module_id')) &&
                    Object.defineProperty(n, /* @__PURE__ */ Symbol.for('mf_module_id'), {
                        value: a,
                        enumerable: false,
                    });
            }
    ...
    class AsyncHook extends SyncHook {
        emit(...e) {
            ...
            if (o.length > 0) {
                let n = 0;
                const a = s =>
                    s === false ? false : n < o.length ? Promise.resolve(o[n++].apply(null, e)).then(a) : s;
                r = a();
            }
    ...
    class AsyncWaterfallHook extends SyncHook {
        ...
        emit(e) {
            ...
            if (r.length > 0) {
                let o = 0;
                const n = s => (warn(s), this.onerror(s), e),
                    a = s => {
        ...
        applyPlugin(e, r) {
            ...
            (assert(o, 'A name must be provided by the plugin.'),
                this.registerPlugins[o] ||
                    ...
                    (_a = e.apply) == null ? void 0 : _a.call(e, r),
    ...
    function assignRemoteInfo(t, e) {
        ...
        (!sdk.isBrowserEnv() && !o.startsWith('http') && (o = `https:${o}`),
            (t.type = r.type),
            (t.entryGlobalName = r.globalName),
            (t.entry = o),
            (t.version = e.version),
    ...
    function traverseModuleInfo(t, e, r, o, n = {}, a) {
        const s = getFMId(e),
            { value: i } = getInfoWithoutType(t, s),
            c = a || i;
    ...
    function generatePreloadAssets(t, e, r, o, n) {
        ...
        if (
            (traverseModuleInfo(
                ...
                (m, y, E) => {
                    ...
                    M.length &&
                        'modules' in m &&
                        (S =
                            (_a = m == null ? void 0 : m.modules) == null
                                ? void 0
                                : _a.reduce(
                                      (N, T) => ((M == null ? void 0 : M.indexOf(T.moduleName)) !== -1 && N.push(T), N),
                                      [],
                                  ));
                    function I(N) {
                    ...
                    if (S) {
                        ...
                        for (let T = 0; T < N; T++) {
                            ...
                            (t.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
                                ...
                                !getPreloaded(A) &&
                                    (b.resourceCategory === 'all'
                                        ? (a.push(...I($.assets.css.async)),
                                          a.push(...I($.assets.css.sync)),
                                          s.push(...I($.assets.js.async)),
                                          s.push(...I($.assets.js.sync)))
                                        : (b.resourceCategory = 'sync') &&
                                          (a.push(...I($.assets.css.sync)), s.push(...I($.assets.js.sync))),
                                    setPreloaded(A)));
                        }
                    }
                },
            ...
            n.shared && n.shared.length > 0)
        ) {
            const m = (y, E) => {
                const b = getRegisteredShare(
                    t.shareScopeMap,
                    E.sharedName,
                    y,
                ...
                b &&
                    typeof b.lib == 'function' &&
                    (E.assets.js.sync.forEach(R => {
                        c.add(R);
                    }),
        ...
        return {
            ...
            async generatePreloadAssets(t) {
                ...
                return sdk.isBrowserEnv()
                    ? isRemoteInfoWithEntry(n) && isPureRemoteEntry(n)
                        ? {
                              cssAssets: [],
    ...
    class SnapshotHandler {
        ...
        async loadRemoteSnapshotInfo({ moduleInfo: e, id: r, expose: o }) {
            ...
            (a ||
                ...
                a &&
                    'remotesInfo' in a &&
                    !getInfoWithoutType(a.remotesInfo, e.name).value &&
            ...
            const { hostGlobalSnapshot: s, remoteSnapshot: i, globalSnapshot: c } = this.getGlobalRemoteInfo(e),
                { remoteSnapshot: l, globalSnapshot: d } = await this.hooks.lifecycle.loadSnapshot.emit({
                    options: n,
                    moduleInfo: e,
            ...
            let h, u;
            if (l)
                if (sdk.isManifestProvider(l)) {
                    const p = sdk.isBrowserEnv() ? l.remoteEntry : l.ssrRemoteEntry || l.remoteEntry || '',
                        _ = await this.getManifestJson(p, e, {}),
                        g = setGlobalSnapshotInfoByModuleInfo(
                            {
                                ...e,
                                entry: p,
                            },
                ...
                const p = await this.getManifestJson(e.entry, e, {}),
                    _ = setGlobalSnapshotInfoByModuleInfo(e, p),
                    { remoteSnapshot: g } = await this.hooks.lifecycle.loadRemoteSnapshot.emit({
                        options: this.HostInstance.options,
                        moduleInfo: e,
                        remoteSnapshot: p,
                        from: 'global',
        ...
        async getManifestJson(e, r, o) {
            const n = async () => {
                    ...
                    return (
                        assert(s.metaData && s.exposes && s.shared, `${e} is not a federation manifest`),
                        this.manifestCache.set(e, s),
                        s
                    );
                },
                a = async () => {
                    const s = await n(),
                        i = sdk.generateSnapshotFromManifest(s, {
                            version: e,
                        }),
    ...
    class SharedHandler {
            ...
            return (
                Object.keys(o).forEach(s => {
                    o[s].forEach(c => {
                        c.scope.forEach(l => {
                            var _a;
                            ((_a = this.shareScopeMap[l]) == null ? void 0 : _a[s]) ||
                                this.setShared({
                                    pkgName: s,
                                    lib: c.lib,
                                    get: c.get,
        ...
        async loadShare(e, r) {
            ...
            const i = getRegisteredShare(this.shareScopeMap, e, s, this.hooks.lifecycle.resolveShare),
                c = l => {
        ...
        initializeSharing(e = DEFAULT_SCOPE, r) {
            const { host: o } = this,
                n = r == null ? void 0 : r.from,
                a = r == null ? void 0 : r.strategy;
            ...
            const d = c[e],
                h = (_, g) => {
                    ...
                    const E = d[_],
                        b = E[m],
                        R = !!(b && (b.eager || ((_a = b.shareConfig) == null ? void 0 : _a.eager)));
                    (!b || (b.strategy !== 'loaded-first' && !b.loaded && (!y != !R ? y : l > b.from))) && (E[m] = g);
                },
                u = _ => _ && _.init && _.init(c[e], s),
                p = async _ => {
            ...
            return (
                Object.keys(o.options.shared).forEach(_ => {
                    o.options.shared[_].forEach(m => {
                        m.scope.includes(e) && h(_, m);
                    });
                }),
                (o.options.shareStrategy === 'version-first' || a === 'version-first') &&
                    o.options.remotes.forEach(_ => {
        ...
        loadShareSync(e, r) {
            ...
            const a = getRegisteredShare(this.shareScopeMap, e, n, this.hooks.lifecycle.resolveShare),
                s = i => {
            ...
            if (a) {
                if (typeof a.lib == 'function')
                    return (
                        s(a),
                        a.loaded || ((a.loaded = true), a.from === o.options.name && (n.loaded = true)),
                        a.lib
                    );
            ...
            if (n.get) {
                ...
                if (i instanceof Promise) {
                    const c =
                        (r == null ? void 0 : r.from) === 'build' ? errorCodes.RUNTIME_005 : errorCodes.RUNTIME_006;
                    throw new Error(
                        errorCodes.getShortErrorMsg(c, errorCodes.runtimeDescMap, {
        ...
        setShared({ pkgName: e, shared: r, from: o, lib: n, loading: a, loaded: s, get: i }) {
            ...
            (Array.isArray(l) ? l : [l]).forEach(u => {
                if (
                    (this.shareScopeMap[u] || (this.shareScopeMap[u] = {}),
                    this.shareScopeMap[u][e] || (this.shareScopeMap[u][e] = {}),
                ...
                (a && !p.loading && (p.loading = a),
                    s && !p.loaded && (p.loaded = s),
                    o && p.from !== o && (p.from = o));
            });
        }
    ...
    class RemoteHandler {
        ...
        async loadRemote(e, r) {
            ...
            try {
                const { loadFactory: n = true } = r || {
                    ...
                    { pkgNameOrAlias: c, remote: l, expose: d, id: h, remoteSnapshot: u } = i,
                    p = await a.get(h, d, r, u),
        ...
        async preloadRemote(e) {
            ...
            await Promise.all(
                o.map(async n => {
                    const { remote: a } = n,
                        s = getRemoteInfo(a),
                        { globalSnapshot: i, remoteSnapshot: c } = await r.snapshotHandler.loadRemoteSnapshotInfo({
                            moduleInfo: a,
                        }),
        ...
        async getRemoteModuleAndOptions(e) {
            ...
            const { id: a } = n,
                s = matchRemoteWithNameAndExpose(r.options.remotes, a);
            assert(
                s,
            ...
            return (
                u || ((u = new Module(p)), r.moduleCache.set(d.name, u)),
                {
                    module: u,
                    moduleOptions: p,
                    remoteMatchInfo: l,
                ...
                a = () => {
                    if (e.alias) {
                        const i = r.find(c => {
                            ...
                            return (
                                e.alias &&
                                (c.name.startsWith(e.alias) ||
                                    ((_a = c.alias) == null ? void 0 : _a.startsWith(e.alias)))
                            );
                        });
                        assert(
                            !i,
                            `The alias ${e.alias} of remote ${e.name} is not allowed to be the prefix of ${i && i.name} name or alias`,
                        );
                    }
                    ('entry' in e &&
                        sdk.isBrowserEnv() &&
        ...
        removeRemote(e) {
            ...
            try {
                const { host: r } = this,
                    { name: o } = e,
                    n = r.options.remotes.findIndex(s => s.name === o);
                n !== -1 && r.options.remotes.splice(n, 1);
                const a = r.moduleCache.get(e.name);
                if (a) {
                    const s = a.remoteInfo,
                        i = s.entryGlobalName;
                    CurrentGlobal[i] &&
                        (((_a = Object.getOwnPropertyDescriptor(CurrentGlobal, i)) == null ? void 0 : _a.configurable)
                            ? delete CurrentGlobal[i]
                            : (CurrentGlobal[i] = void 0));
                    ...
                    const d = CurrentGlobal.__FEDERATION__.__INSTANCES__.findIndex(u =>
                        s.buildVersion ? u.options.id === l : u.name === l,
                    );
                    if (d !== -1) {
                                            ...
                                            S &&
                                                Object.keys(S).forEach(M => {
                                                    ...
                                                    I &&
                                                        ...
                                                        I.from === s.name &&
                                                        (I.loaded || I.loading
                                                            ? ((I.useIn = I.useIn.filter(N => N !== s.name)),
                                                              I.useIn.length ? (_ = false) : g.push([m, E, R, M]))
                                                            : g.push([m, E, R, M]));
                                                });
                                        });
                                });
                        }),
                            _ && ((u.shareScopeMap = {}), delete p[l]),
                            g.forEach(([m, y, E, b]) => {
                                var _a2, _b, _c;
                                (_c = (_b = (_a2 = p[m]) == null ? void 0 : _a2[y]) == null ? void 0 : _b[E]) == null
                                    ? true
                                    : delete _c[b];
                            }),
                    ...
                    if (h) {
                        const u =
                            h && 'remotesInfo' in h && h.remotesInfo && getInfoWithoutType(h.remotesInfo, e.name).key;
                        u &&
                            (delete h.remotesInfo[u],
                            Global.__FEDERATION__.__MANIFEST_LOADING__[u] &&
                                delete Global.__FEDERATION__.__MANIFEST_LOADING__[u]);
                    }
    ...
    class ModuleFederation {
        constructor(e) {
            ...
            const r = USE_SNAPSHOT ? [snapshotPlugin(), generatePreloadAssetsPlugin()] : [],
                o = {
                    id: getBuilderId$1(),
                    name: e.name,
                    plugins: r,
            ...
            ((this.name = e.name),
                ...
                this.registerPlugins([...o.plugins, ...(e.plugins || [])]),
        ...
        formatOptions(e, r) {
            const { shared: o } = formatShareConfigs(e, r),
                { userOptions: n, options: a } = this.hooks.lifecycle.beforeInit.emit({
                    origin: this,
                    userOptions: r,
                    options: e,
                    shareInfo: o,
                }),
                s = this.remoteHandler.formatAndRegisterRemote(a, n),
                { shared: i } = this.sharedHandler.registerShared(a, n),
                c = [...a.plugins];
            n.plugins &&
                n.plugins.forEach(d => {
        ...
        registerPlugins(e) {
            ...
            this.options.plugins = this.options.plugins.reduce(
                (o, n) => (n && o && !o.find(a => a.name === n.name) && o.push(n), o),
                r || [],
            );
        }
        registerRemotes(e, r) {
    ...
    var utils_cjs = {},
        runtimeCore$1 = index_cjs$2;
    function getBuilderId() {
        return typeof FEDERATION_BUILD_IDENTIFIER < 'u' ? FEDERATION_BUILD_IDENTIFIER : '';
    }
    function getGlobalFederationInstance(t, e) {
        const r = getBuilderId();
        return runtimeCore$1.CurrentGlobal.__FEDERATION__.__INSTANCES__.find(
            o =>
                !!(
                    (r && o.options.id === r) ||
                    (o.options.name === t && !o.options.version && !e) ||
                    (o.options.name === t && e && o.options.version === e)
                ),
        );
    }
    ...
    function init$1(t) {
        ...
        return e
            ? (e.initOptions(t), FederationInstance || (FederationInstance = e), e)
            : ((FederationInstance = createInstance(t)), FederationInstance);
    }
    ...
    const importMap = {
            react: async () =>
                await __vitePreload(
                    () => import('./assets/index-BEpFHtMA.js').then(e => e.i),
                    __vite__mapDeps([0, 1]),
                    import.meta.url,
                ),
            'react-dom': async () =>
                await __vitePreload(
                    () =>
                        import('./assets/index-UMzeul1g.js')
                            .then(async m => {
                                await m.__tla;
                                return m;
                            })
    ...
    init = async function (t = {}, e = []) {
        ...
        if (
            ...
            try {
                await Promise.all(
                    await r.initializeSharing('default', {
...
export { __tla, getExposes as get, init };
